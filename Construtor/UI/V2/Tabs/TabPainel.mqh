...
public:
   bool Create(CEF_CWndCreate &host,int window_index,CEF_CTabs &tabs,const int tab_index)
     {
      return(CreatePlaceholder(host,window_index,tabs,tab_index,"Estrutura reservada para o painel consolidado. Este arquivo pode concentrar leitura visual, status e botoes finais."));
     }
  };
