      ...
      for(int i=0;i<14;i++)
        {
         if(i==0)
         ...
         else if(i==13)
           {
            ...
            if(!CreateTextLabel(m_tab8_sobre_desvio_price_label,"Modo de preço",m_tab8_sobre_param_tabs,m_window_index,m_tab8_sobre_param_tabs,i,sobre_param_content_x,desvio_y3,desvio_label_w,desvio_control_h))
               return(false);
