...
private:
   ...
   CEF_CTextLabel    m_tab8_montar_keltner_title[4];
   CEF_CTextLabel    m_tab8_montar_keltner_period_label[4];
   CEF_CTextEdit     m_tab8_montar_keltner_period_spin[4];
   CEF_CTextLabel    m_tab8_montar_keltner_deviation_label[4];
   ...
   CEF_CTextLabel    m_tab8_montar_regressao_title[4];
   CEF_CTextLabel    m_tab8_montar_regressao_period_label[4];
   CEF_CTextEdit     m_tab8_montar_regressao_period_spin[4];
   CEF_CTextLabel    m_tab8_montar_regressao_ma_type_label[4];
   CEF_CComboBox     m_tab8_montar_regressao_ma_type_combo[4];
   CEF_CTextLabel    m_tab8_montar_regressao_price_label[4];
   CEF_CComboBox     m_tab8_montar_regressao_price_combo[4];
   CEF_CTextLabel    m_tab8_montar_afast_title[4];
   CEF_CTextLabel    m_tab8_montar_afast_period_label[4];
   CEF_CTextEdit     m_tab8_montar_afast_period_spin[4];
   CEF_CTextLabel    m_tab8_montar_afast_shift_label[4];
   CEF_CTextEdit     m_tab8_montar_afast_shift_spin[4];
   CEF_CTextLabel    m_tab8_montar_afast_ma_type_label[4];
   CEF_CComboBox     m_tab8_montar_afast_ma_type_combo[4];
   CEF_CTextLabel    m_tab8_montar_afast_price_label[4];
   CEF_CComboBox     m_tab8_montar_afast_price_combo[4];
   CEF_CTextLabel    m_tab8_montar_desvio_title[4];
   CEF_CTextLabel    m_tab8_montar_desvio_period_label[4];
   CEF_CTextEdit     m_tab8_montar_desvio_period_spin[4];
   CEF_CTextLabel    m_tab8_montar_desvio_ma_type_label[4];
   CEF_CComboBox     m_tab8_montar_desvio_ma_type_combo[4];
   CEF_CTextLabel    m_tab8_montar_desvio_price_label[4];
   CEF_CComboBox     m_tab8_montar_desvio_price_combo[4];
   CEF_CTextLabel    m_tab8_montar_atr_title[4];
   CEF_CTextLabel    m_tab8_montar_atr_period_label[4];
   CEF_CTextEdit     m_tab8_montar_atr_period_spin[4];
   CEF_CTextLabel    m_tab8_montar_atr_deviation_label[4];
   CEF_CTextEdit     m_tab8_montar_atr_deviation_spin[4];
   CEF_CTextLabel    m_tab8_montar_media_title[4];
   CEF_CTextLabel    m_tab8_montar_media_period_label[4];
   CEF_CTextEdit     m_tab8_montar_media_period_spin[4];
   CEF_CTextLabel    m_tab8_montar_media_shift_label[4];
   CEF_CTextEdit     m_tab8_montar_media_shift_spin[4];
   CEF_CTextLabel    m_tab8_montar_media_ma_type_label[4];
   CEF_CComboBox     m_tab8_montar_media_ma_type_combo[4];
   CEF_CTextLabel    m_tab8_montar_media_price_label[4];
   CEF_CComboBox     m_tab8_montar_media_price_combo[4];
   CEF_CTextLabel    m_tab8_montar_bandas_title[4];
   CEF_CTextLabel    m_tab8_montar_bandas_period_label[4];
   CEF_CTextEdit     m_tab8_montar_bandas_period_spin[4];
   CEF_CTextLabel    m_tab8_montar_bandas_deviation_label[4];
   CEF_CTextEdit     m_tab8_montar_bandas_deviation_spin[4];
   CEF_CTextLabel    m_tab8_montar_bandas_shift_label[4];
   CEF_CTextEdit     m_tab8_montar_bandas_shift_spin[4];
   CEF_CTextLabel    m_tab8_montar_bandas_price_label[4];
   CEF_CComboBox     m_tab8_montar_bandas_price_combo[4];
   CEF_CTextLabel    m_tab8_montar_envelopes_title[4];
   CEF_CTextLabel    m_tab8_montar_envelopes_period_label[4];
   CEF_CTextEdit     m_tab8_montar_envelopes_period_spin[4];
   CEF_CTextLabel    m_tab8_montar_envelopes_shift_label[4];
   CEF_CTextEdit     m_tab8_montar_envelopes_shift_spin[4];
   CEF_CTextLabel    m_tab8_montar_envelopes_ma_type_label[4];
   CEF_CComboBox     m_tab8_montar_envelopes_ma_type_combo[4];
   CEF_CTextLabel    m_tab8_montar_envelopes_deviation_label[4];
   CEF_CTextEdit     m_tab8_montar_envelopes_deviation_spin[4];
   CEF_CTextLabel    m_tab8_montar_stoch_title[4];
   CEF_CTextLabel    m_tab8_montar_stoch_k_label[4];
   CEF_CTextEdit     m_tab8_montar_stoch_k_spin[4];
   CEF_CTextLabel    m_tab8_montar_stoch_d_label[4];
   CEF_CTextEdit     m_tab8_montar_stoch_d_spin[4];
   CEF_CTextLabel    m_tab8_montar_stoch_slow_label[4];
   CEF_CTextEdit     m_tab8_montar_stoch_slow_spin[4];
   CEF_CTextLabel    m_tab8_montar_stoch_ma_type_label[4];
   CEF_CComboBox     m_tab8_montar_stoch_ma_type_combo[4];
   CEF_CTextLabel    m_tab8_montar_stoch_price_type_label[4];
   CEF_CComboBox     m_tab8_montar_stoch_price_type_combo[4];
   CEF_CTextLabel    m_tab8_montar_rsi_title[4];
   CEF_CTextLabel    m_tab8_montar_rsi_period_label[4];
   CEF_CTextEdit     m_tab8_montar_rsi_period_spin[4];
   CEF_CTextLabel    m_tab8_montar_rsi_price_label[4];
   CEF_CComboBox     m_tab8_montar_rsi_price_combo[4];
   CEF_CTextLabel    m_tab8_montar_stddev_title[4];
   CEF_CTextLabel    m_tab8_montar_stddev_period_label[4];
   CEF_CTextEdit     m_tab8_montar_stddev_period_spin[4];
   CEF_CTextLabel    m_tab8_montar_stddev_shift_label[4];
   CEF_CTextEdit     m_tab8_montar_stddev_shift_spin[4];
   CEF_CTextLabel    m_tab8_montar_stddev_ma_type_label[4];
   CEF_CComboBox     m_tab8_montar_stddev_ma_type_combo[4];
   CEF_CTextLabel    m_tab8_montar_stddev_price_label[4];
   CEF_CComboBox     m_tab8_montar_stddev_price_combo[4];
   CEF_CTextLabel    m_tab8_montar_volume_title[4];
   CEF_CTextLabel    m_tab8_montar_volume_type_label[4];
   CEF_CComboBox     m_tab8_montar_volume_type_combo[4];
   CEF_CTextLabel    m_tab8_montar_atr_simple_title[4];
   CEF_CTextLabel    m_tab8_montar_atr_simple_period_label[4];
   CEF_CTextEdit     m_tab8_montar_atr_simple_period_spin[4];
   CEF_CTextLabel    m_tab8_montar_sar_title[4];
   CEF_CTextLabel    m_tab8_montar_sar_step_label[4];
   CEF_CTextEdit     m_tab8_montar_sar_step_spin[4];
   CEF_CTextLabel    m_tab8_montar_sar_max_label[4];
   ...
   CEF_CTextLabel    m_tab8_montar_macd_slow_label[4];
   CEF_CTextEdit     m_tab8_montar_macd_slow_spin[4];
   CEF_CTextLabel    m_tab8_montar_macd_signal_label[4];
   CEF_CTextEdit     m_tab8_montar_macd_signal_spin[4];
   CEF_CTextLabel    m_tab8_montar_macd_price_label[4];
   CEF_CComboBox     m_tab8_montar_macd_price_combo[4];
...
private:
   ...
   void RefreshMontarValueCombos(void)
     {
      const int max_value_items=77; // 17 fixos + ate 60 dinamicos (4 slots * 15 saidas)
      string value_items[];
      ...
      for(int slot=0;slot<4;slot++)
        {
         ...
         if(idx==1) // Keltner
         ...
         else if(idx==3) // Regressao
           {
            const string prefix=(string)(slot+1)+" regressao ";
            value_items[total++]=prefix+"Ratio";
           }
         else if(idx==4) // Afastamento da media
           {
            const string prefix=(string)(slot+1)+" afastamento ";
            value_items[total++]=prefix+"medio";
           }
         else if(idx==5) // Desvio medio
           {
            const string prefix=(string)(slot+1)+" desvio ";
            value_items[total++]=prefix+"afastamento";
            value_items[total++]=prefix+"medio";
           }
         else if(idx==6) // Canal ATR
           {
            const string prefix=(string)(slot+1)+" atr ";
            value_items[total++]=prefix+"superior";
            value_items[total++]=prefix+"central";
            value_items[total++]=prefix+"inferior";
           }
         else if(idx==7) // Media movel
           {
            const string prefix=(string)(slot+1)+" ";
            value_items[total++]=prefix+"media movel";
           }
         else if(idx==8) // Bandas de Bolinger
           {
            const string prefix=(string)(slot+1)+" bandas ";
            value_items[total++]=prefix+"superior";
            value_items[total++]=prefix+"central";
            value_items[total++]=prefix+"inferior";
           }
           ...
           {
            value_items[total++]=(string)(slot+1)+" macd histograma";
            value_items[total++]=(string)(slot+1)+" mack sinal";
           }
         else if(idx==10) // Envelopes
           {
            const string prefix=(string)(slot+1)+" envelope ";
            value_items[total++]=prefix+"superior";
            value_items[total++]=prefix+"inferior";
           }
         else if(idx==11) // Estocastico
           {
            const string prefix=(string)(slot+1)+" estocastico ";
            value_items[total++]=prefix+"principal";
            value_items[total++]=prefix+"sinal";
           }
         else if(idx==12) // RSI
           {
            value_items[total++]=(string)(slot+1)+" rsi";
           }
         else if(idx==13) // Desvio padrao
           {
            value_items[total++]=(string)(slot+1)+" desvio padrao";
           }
         else if(idx==14) // Volume
          {
            value_items[total++]=(string)(slot+1)+" volume";
           }
         else if(idx==15) // ATR
           {
            value_items[total++]=(string)(slot+1)+" atr";
           }
         else if(idx==16) // Parabolic SAR
           {
            value_items[total++]=(string)(slot+1)+" parabolic sar";
           }
         else if(idx==17) // Fractal
           {
            const string prefix=(string)(slot+1)+" fractal ";
            value_items[total++]=prefix+"superior";
            value_items[total++]=prefix+"inferior";
           }
        }
   ...
   bool CreateIfNeeded(void)
     {
      ...
      const int montar_param_gap_x=12;
      ...
      montar_ma_type_items[0]="Simples (SMA)";
      montar_ma_type_items[1]="Exponencial (EMA)";
      montar_ma_type_items[2]="Suavisada (SMMA)";
      montar_ma_type_items[3]="Linear-ponderada (LWMA)";
      string montar_price_items[];
      ArrayResize(montar_price_items,7);
      montar_price_items[0]="Fechamento";
      montar_price_items[1]="Abertura";
      montar_price_items[2]="Máximo";
      montar_price_items[3]="Mínimo";
      montar_price_items[4]="Mediano";
      montar_price_items[5]="Tipico";
      montar_price_items[6]="Medio";
      string montar_stoch_type_items[];
      ArrayResize(montar_stoch_type_items,2);
      montar_stoch_type_items[0]="Mínimo/Máximo";
      montar_stoch_type_items[1]="Fechamento/Fechamento";

      for(int i=0;i<4;i++)
        {
         const int montar_col=i;
         const int montar_row=0;
         ...
         montar_card_tabs_text[3]="4";
         montar_card_tabs_text[4]="5";
         montar_card_tabs_text[5]="6";
         montar_card_tabs_text[6]="7";
         montar_card_tabs_text[7]="8";
         montar_card_tabs_text[8]="9";
         montar_card_tabs_text[9]="10";
         montar_card_tabs_text[10]="11";
         montar_card_tabs_text[11]="12";
         montar_card_tabs_text[12]="13";
         montar_card_tabs_text[13]="14";
         ...
         montar_card_tabs_widths[3]=15;
         montar_card_tabs_widths[4]=15;
         montar_card_tabs_widths[5]=15;
         montar_card_tabs_widths[6]=15;
         montar_card_tabs_widths[7]=15;
         montar_card_tabs_widths[8]=15;
         montar_card_tabs_widths[9]=22;
         montar_card_tabs_widths[10]=22;
         montar_card_tabs_widths[11]=22;
         montar_card_tabs_widths[12]=22;
         montar_card_tabs_widths[13]=22;
         ...
         m_tab8_montar_param_card_tabs[i].PositionMode(TABS_LEFT);
            ...
            if(p==0)
              {
               ...
               const string montar_keltner_title=(string)(i+1)+" kelter";

               if(!CreateTextLabel(m_tab8_montar_keltner_title[i],montar_keltner_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_keltner_x,montar_keltner_title_y,montar_keltner_w,16))
                  return(false);
               m_tab8_montar_keltner_title[i].FontSize(9);
               m_tab8_montar_keltner_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_keltner_period_label[i],"Período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_keltner_x,montar_keltner_y,montar_keltner_w,16))
                  return(false);
               m_tab8_montar_keltner_period_label[i].FontSize(9);
               m_tab8_montar_keltner_period_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_keltner_period_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_keltner_period_spin[i]);
               m_tab8_montar_keltner_period_spin[i].XSize(montar_keltner_w);
               m_tab8_montar_keltner_period_spin[i].MaxValue(9999.0);
               m_tab8_montar_keltner_period_spin[i].MinValue(1.0);
               m_tab8_montar_keltner_period_spin[i].StepValue(1.0);
               m_tab8_montar_keltner_period_spin[i].SetDigits(0);
               m_tab8_montar_keltner_period_spin[i].SpinEditMode(true);
               m_tab8_montar_keltner_period_spin[i].CheckBoxMode(false);
               m_tab8_montar_keltner_period_spin[i].SetValue("20");
               m_tab8_montar_keltner_period_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_keltner_period_spin[i].GetTextBoxPointer().XSize(montar_keltner_spin_edit_w);
               m_tab8_montar_keltner_period_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_keltner_period_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_keltner_period_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_keltner_period_spin[i].CreateTextEdit("",montar_keltner_x,montar_keltner_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_keltner_period_spin[i]);
               m_tab8_montar_keltner_period_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_keltner_period_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_keltner_period_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_keltner_period_spin[i].BorderColor(tab2_border);
               m_tab8_montar_keltner_period_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_keltner_period_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_keltner_period_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_keltner_period_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_keltner_period_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_keltner_period_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_keltner_period_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_keltner_period_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_keltner_deviation_label[i],"Desvios",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_keltner_x,montar_keltner_y+44,montar_keltner_w,16))
                  return(false);
               m_tab8_montar_keltner_deviation_label[i].FontSize(9);
               m_tab8_montar_keltner_deviation_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_keltner_deviation_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_keltner_deviation_spin[i]);
               m_tab8_montar_keltner_deviation_spin[i].XSize(montar_keltner_w);
               m_tab8_montar_keltner_deviation_spin[i].MaxValue(9999.0);
               m_tab8_montar_keltner_deviation_spin[i].MinValue(0.0);
               m_tab8_montar_keltner_deviation_spin[i].StepValue(0.1);
               m_tab8_montar_keltner_deviation_spin[i].SetDigits(1);
               m_tab8_montar_keltner_deviation_spin[i].SpinEditMode(true);
               m_tab8_montar_keltner_deviation_spin[i].CheckBoxMode(false);
               m_tab8_montar_keltner_deviation_spin[i].SetValue("2");
               m_tab8_montar_keltner_deviation_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_keltner_deviation_spin[i].GetTextBoxPointer().XSize(montar_keltner_spin_edit_w);
               m_tab8_montar_keltner_deviation_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_keltner_deviation_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_keltner_deviation_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_keltner_deviation_spin[i].CreateTextEdit("",montar_keltner_x,montar_keltner_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_keltner_deviation_spin[i]);
               m_tab8_montar_keltner_deviation_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_keltner_deviation_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_keltner_deviation_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_keltner_deviation_spin[i].BorderColor(tab2_border);
               m_tab8_montar_keltner_deviation_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_keltner_deviation_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_keltner_deviation_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_keltner_deviation_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_keltner_deviation_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_keltner_deviation_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_keltner_deviation_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_keltner_deviation_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_keltner_ma_type_label[i],"Tipo de média",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_keltner_x,montar_keltner_y+88,montar_keltner_w,16))
                  return(false);
               m_tab8_montar_keltner_ma_type_label[i].FontSize(9);
               m_tab8_montar_keltner_ma_type_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_keltner_ma_type_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_keltner_ma_type_combo[i]);
               m_tab8_montar_keltner_ma_type_combo[i].XSize(montar_keltner_w);
               m_tab8_montar_keltner_ma_type_combo[i].YSize(montar_keltner_h);
               m_tab8_montar_keltner_ma_type_combo[i].BackColor(clrWhite);
               m_tab8_montar_keltner_ma_type_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_keltner_ma_type_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_keltner_ma_type_combo[i].BorderColor(tab2_border);
               m_tab8_montar_keltner_ma_type_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_keltner_ma_type_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_keltner_ma_type_combo[i].FontSize(10);
               m_tab8_montar_keltner_ma_type_combo[i].ItemsTotal(ArraySize(montar_ma_type_items));
               m_tab8_montar_keltner_ma_type_combo[i].CheckBoxMode(false);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().XSize(montar_keltner_w-2);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().YSize(montar_keltner_h);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().IconXGap((montar_keltner_w-2)-18);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_keltner_ma_type_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_ma_type_items);m++) m_tab8_montar_keltner_ma_type_combo[i].SetValue(m,montar_ma_type_items[m]);
               m_tab8_montar_keltner_ma_type_combo[i].GetListViewPointer().YSize(140);
               m_tab8_montar_keltner_ma_type_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_keltner_ma_type_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_keltner_ma_type_combo[i].CreateComboBox("",montar_keltner_x,montar_keltner_y+104))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_keltner_ma_type_combo[i]);
               m_tab8_montar_keltner_ma_type_combo[i].SelectItem(0);
              }
            else if(p==1)
              {
              ...
              {
               const int montar_regressao_x=12;
               const int montar_regressao_title_y=8;
               const int montar_regressao_y=28;
               const int montar_regressao_w=montar_param_card_w-48;
               const int montar_regressao_h=20;
               const int montar_regressao_spin_edit_w=montar_regressao_w-34;
               const string montar_regressao_title=(string)(i+1)+" regressao";

               if(!CreateTextLabel(m_tab8_montar_regressao_title[i],montar_regressao_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_regressao_x,montar_regressao_title_y,montar_regressao_w,16))
                  return(false);
               m_tab8_montar_regressao_title[i].FontSize(9);
               m_tab8_montar_regressao_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_regressao_period_label[i],"Período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_regressao_x,montar_regressao_y,montar_regressao_w,16))
                  return(false);
               m_tab8_montar_regressao_period_label[i].FontSize(9);
               m_tab8_montar_regressao_period_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_regressao_period_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_regressao_period_spin[i]);
               m_tab8_montar_regressao_period_spin[i].XSize(montar_regressao_w);
               m_tab8_montar_regressao_period_spin[i].MaxValue(9999.0);
               m_tab8_montar_regressao_period_spin[i].MinValue(1.0);
               m_tab8_montar_regressao_period_spin[i].StepValue(1.0);
               m_tab8_montar_regressao_period_spin[i].SetDigits(0);
               m_tab8_montar_regressao_period_spin[i].SpinEditMode(true);
               m_tab8_montar_regressao_period_spin[i].CheckBoxMode(false);
               m_tab8_montar_regressao_period_spin[i].SetValue("18");
               m_tab8_montar_regressao_period_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_regressao_period_spin[i].GetTextBoxPointer().XSize(montar_regressao_spin_edit_w);
               m_tab8_montar_regressao_period_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_regressao_period_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_regressao_period_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_regressao_period_spin[i].CreateTextEdit("",montar_regressao_x,montar_regressao_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_regressao_period_spin[i]);
               m_tab8_montar_regressao_period_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_regressao_period_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_regressao_period_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_regressao_period_spin[i].BorderColor(tab2_border);
               m_tab8_montar_regressao_period_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_regressao_period_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_regressao_period_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_regressao_period_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_regressao_period_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_regressao_period_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_regressao_period_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_regressao_period_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_regressao_ma_type_label[i],"Tipo de média",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_regressao_x,montar_regressao_y+44,montar_regressao_w,16))
                  return(false);
               m_tab8_montar_regressao_ma_type_label[i].FontSize(9);
               m_tab8_montar_regressao_ma_type_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_regressao_ma_type_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_regressao_ma_type_combo[i]);
               m_tab8_montar_regressao_ma_type_combo[i].XSize(montar_regressao_w);
               m_tab8_montar_regressao_ma_type_combo[i].YSize(montar_regressao_h);
               m_tab8_montar_regressao_ma_type_combo[i].BackColor(clrWhite);
               m_tab8_montar_regressao_ma_type_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_regressao_ma_type_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_regressao_ma_type_combo[i].BorderColor(tab2_border);
               m_tab8_montar_regressao_ma_type_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_regressao_ma_type_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_regressao_ma_type_combo[i].FontSize(10);
               m_tab8_montar_regressao_ma_type_combo[i].ItemsTotal(ArraySize(montar_ma_type_items));
               m_tab8_montar_regressao_ma_type_combo[i].CheckBoxMode(false);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().XSize(montar_regressao_w-2);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().YSize(montar_regressao_h);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().IconXGap((montar_regressao_w-2)-18);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_regressao_ma_type_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_ma_type_items);m++) m_tab8_montar_regressao_ma_type_combo[i].SetValue(m,montar_ma_type_items[m]);
               m_tab8_montar_regressao_ma_type_combo[i].GetListViewPointer().YSize(140);
               m_tab8_montar_regressao_ma_type_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_regressao_ma_type_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_regressao_ma_type_combo[i].CreateComboBox("",montar_regressao_x,montar_regressao_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_regressao_ma_type_combo[i]);
               m_tab8_montar_regressao_ma_type_combo[i].SelectItem(0);

               if(!CreateTextLabel(m_tab8_montar_regressao_price_label[i],"Modo de preço",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_regressao_x,montar_regressao_y+88,montar_regressao_w,16))
                  return(false);
               m_tab8_montar_regressao_price_label[i].FontSize(9);
               m_tab8_montar_regressao_price_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_regressao_price_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_regressao_price_combo[i]);
               m_tab8_montar_regressao_price_combo[i].XSize(montar_regressao_w);
               m_tab8_montar_regressao_price_combo[i].YSize(montar_regressao_h);
               m_tab8_montar_regressao_price_combo[i].BackColor(clrWhite);
               m_tab8_montar_regressao_price_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_regressao_price_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_regressao_price_combo[i].BorderColor(tab2_border);
               m_tab8_montar_regressao_price_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_regressao_price_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_regressao_price_combo[i].FontSize(10);
               m_tab8_montar_regressao_price_combo[i].ItemsTotal(ArraySize(montar_price_items));
               m_tab8_montar_regressao_price_combo[i].CheckBoxMode(false);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().XSize(montar_regressao_w-2);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().YSize(montar_regressao_h);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().IconXGap((montar_regressao_w-2)-18);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_regressao_price_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_price_items);m++) m_tab8_montar_regressao_price_combo[i].SetValue(m,montar_price_items[m]);
               m_tab8_montar_regressao_price_combo[i].GetListViewPointer().YSize(160);
               m_tab8_montar_regressao_price_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_regressao_price_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_regressao_price_combo[i].CreateComboBox("",montar_regressao_x,montar_regressao_y+104))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_regressao_price_combo[i]);
               m_tab8_montar_regressao_price_combo[i].SelectItem(0);
              }
            else if(p==3)
              {
               const int montar_afast_x=12;
               const int montar_afast_title_y=8;
               const int montar_afast_y=28;
               const int montar_afast_w=montar_param_card_w-48;
               const int montar_afast_h=20;
               const int montar_afast_spin_edit_w=montar_afast_w-34;
               const string montar_afast_title=(string)(i+1)+" afastamento medio";

               if(!CreateTextLabel(m_tab8_montar_afast_title[i],montar_afast_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_afast_x,montar_afast_title_y,montar_afast_w,16))
                  return(false);
               m_tab8_montar_afast_title[i].FontSize(9);
               m_tab8_montar_afast_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_afast_period_label[i],"Período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_afast_x,montar_afast_y,montar_afast_w,16))
                  return(false);
               m_tab8_montar_afast_period_label[i].FontSize(9);
               m_tab8_montar_afast_period_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_afast_period_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_afast_period_spin[i]);
               m_tab8_montar_afast_period_spin[i].XSize(montar_afast_w);
               m_tab8_montar_afast_period_spin[i].MaxValue(9999.0);
               m_tab8_montar_afast_period_spin[i].MinValue(1.0);
               m_tab8_montar_afast_period_spin[i].StepValue(1.0);
               m_tab8_montar_afast_period_spin[i].SetDigits(0);
               m_tab8_montar_afast_period_spin[i].SpinEditMode(true);
               m_tab8_montar_afast_period_spin[i].CheckBoxMode(false);
               m_tab8_montar_afast_period_spin[i].SetValue("14");
               m_tab8_montar_afast_period_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_afast_period_spin[i].GetTextBoxPointer().XSize(montar_afast_spin_edit_w);
               m_tab8_montar_afast_period_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_afast_period_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_afast_period_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_afast_period_spin[i].CreateTextEdit("",montar_afast_x,montar_afast_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_afast_period_spin[i]);
               m_tab8_montar_afast_period_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_afast_period_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_afast_period_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_afast_period_spin[i].BorderColor(tab2_border);
               m_tab8_montar_afast_period_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_afast_period_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_afast_period_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_afast_period_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_afast_period_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_afast_period_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_afast_period_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_afast_period_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_afast_shift_label[i],"Deslocamento",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_afast_x,montar_afast_y+44,montar_afast_w,16))
                  return(false);
               m_tab8_montar_afast_shift_label[i].FontSize(9);
               m_tab8_montar_afast_shift_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_afast_shift_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_afast_shift_spin[i]);
               m_tab8_montar_afast_shift_spin[i].XSize(montar_afast_w);
               m_tab8_montar_afast_shift_spin[i].MaxValue(9999.0);
               m_tab8_montar_afast_shift_spin[i].MinValue(0.0);
               m_tab8_montar_afast_shift_spin[i].StepValue(1.0);
               m_tab8_montar_afast_shift_spin[i].SetDigits(0);
               m_tab8_montar_afast_shift_spin[i].SpinEditMode(true);
               m_tab8_montar_afast_shift_spin[i].CheckBoxMode(false);
               m_tab8_montar_afast_shift_spin[i].SetValue("0");
               m_tab8_montar_afast_shift_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_afast_shift_spin[i].GetTextBoxPointer().XSize(montar_afast_spin_edit_w);
               m_tab8_montar_afast_shift_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_afast_shift_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_afast_shift_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_afast_shift_spin[i].CreateTextEdit("",montar_afast_x,montar_afast_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_afast_shift_spin[i]);
               m_tab8_montar_afast_shift_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_afast_shift_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_afast_shift_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_afast_shift_spin[i].BorderColor(tab2_border);
               m_tab8_montar_afast_shift_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_afast_shift_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_afast_shift_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_afast_shift_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_afast_shift_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_afast_shift_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_afast_shift_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_afast_shift_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_afast_ma_type_label[i],"Tipo de média",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_afast_x,montar_afast_y+88,montar_afast_w,16))
                  return(false);
               m_tab8_montar_afast_ma_type_label[i].FontSize(9);
               m_tab8_montar_afast_ma_type_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_afast_ma_type_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_afast_ma_type_combo[i]);
               m_tab8_montar_afast_ma_type_combo[i].XSize(montar_afast_w);
               m_tab8_montar_afast_ma_type_combo[i].YSize(montar_afast_h);
               m_tab8_montar_afast_ma_type_combo[i].BackColor(clrWhite);
               m_tab8_montar_afast_ma_type_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_afast_ma_type_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_afast_ma_type_combo[i].BorderColor(tab2_border);
               m_tab8_montar_afast_ma_type_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_afast_ma_type_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_afast_ma_type_combo[i].FontSize(10);
               m_tab8_montar_afast_ma_type_combo[i].ItemsTotal(ArraySize(montar_ma_type_items));
               m_tab8_montar_afast_ma_type_combo[i].CheckBoxMode(false);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().XSize(montar_afast_w-2);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().YSize(montar_afast_h);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().IconXGap((montar_afast_w-2)-18);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_afast_ma_type_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_ma_type_items);m++) m_tab8_montar_afast_ma_type_combo[i].SetValue(m,montar_ma_type_items[m]);
               m_tab8_montar_afast_ma_type_combo[i].GetListViewPointer().YSize(140);
               m_tab8_montar_afast_ma_type_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_afast_ma_type_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_afast_ma_type_combo[i].CreateComboBox("",montar_afast_x,montar_afast_y+104))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_afast_ma_type_combo[i]);
               m_tab8_montar_afast_ma_type_combo[i].SelectItem(0);

               if(!CreateTextLabel(m_tab8_montar_afast_price_label[i],"Modo de preço",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_afast_x,montar_afast_y+132,montar_afast_w,16))
                  return(false);
               m_tab8_montar_afast_price_label[i].FontSize(9);
               m_tab8_montar_afast_price_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_afast_price_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_afast_price_combo[i]);
               m_tab8_montar_afast_price_combo[i].XSize(montar_afast_w);
               m_tab8_montar_afast_price_combo[i].YSize(montar_afast_h);
               m_tab8_montar_afast_price_combo[i].BackColor(clrWhite);
               m_tab8_montar_afast_price_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_afast_price_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_afast_price_combo[i].BorderColor(tab2_border);
               m_tab8_montar_afast_price_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_afast_price_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_afast_price_combo[i].FontSize(10);
               m_tab8_montar_afast_price_combo[i].ItemsTotal(ArraySize(montar_price_items));
               m_tab8_montar_afast_price_combo[i].CheckBoxMode(false);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().XSize(montar_afast_w-2);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().YSize(montar_afast_h);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().IconXGap((montar_afast_w-2)-18);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_afast_price_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_price_items);m++) m_tab8_montar_afast_price_combo[i].SetValue(m,montar_price_items[m]);
               m_tab8_montar_afast_price_combo[i].GetListViewPointer().YSize(160);
               m_tab8_montar_afast_price_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_afast_price_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_afast_price_combo[i].CreateComboBox("",montar_afast_x,montar_afast_y+148))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_afast_price_combo[i]);
               m_tab8_montar_afast_price_combo[i].SelectItem(0);
              }
            else if(p==4)
              {
               const int montar_desvio_x=12;
               const int montar_desvio_title_y=8;
               const int montar_desvio_y=28;
               const int montar_desvio_w=montar_param_card_w-48;
               const int montar_desvio_h=20;
               const int montar_desvio_spin_edit_w=montar_desvio_w-34;
               const string montar_desvio_title=(string)(i+1)+" desvio medio";

               if(!CreateTextLabel(m_tab8_montar_desvio_title[i],montar_desvio_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_desvio_x,montar_desvio_title_y,montar_desvio_w,16))
                  return(false);
               m_tab8_montar_desvio_title[i].FontSize(9);
               m_tab8_montar_desvio_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_desvio_period_label[i],"Período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_desvio_x,montar_desvio_y,montar_desvio_w,16))
                  return(false);
               m_tab8_montar_desvio_period_label[i].FontSize(9);
               m_tab8_montar_desvio_period_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_desvio_period_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_desvio_period_spin[i]);
               m_tab8_montar_desvio_period_spin[i].XSize(montar_desvio_w);
               m_tab8_montar_desvio_period_spin[i].MaxValue(9999.0);
               m_tab8_montar_desvio_period_spin[i].MinValue(1.0);
               m_tab8_montar_desvio_period_spin[i].StepValue(1.0);
               m_tab8_montar_desvio_period_spin[i].SetDigits(0);
               m_tab8_montar_desvio_period_spin[i].SpinEditMode(true);
               m_tab8_montar_desvio_period_spin[i].CheckBoxMode(false);
               m_tab8_montar_desvio_period_spin[i].SetValue("14");
               m_tab8_montar_desvio_period_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_desvio_period_spin[i].GetTextBoxPointer().XSize(montar_desvio_spin_edit_w);
               m_tab8_montar_desvio_period_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_desvio_period_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_desvio_period_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_desvio_period_spin[i].CreateTextEdit("",montar_desvio_x,montar_desvio_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_desvio_period_spin[i]);
               m_tab8_montar_desvio_period_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_desvio_period_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_desvio_period_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_desvio_period_spin[i].BorderColor(tab2_border);
               m_tab8_montar_desvio_period_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_desvio_period_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_desvio_period_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_desvio_period_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_desvio_period_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_desvio_period_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_desvio_period_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_desvio_period_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_desvio_ma_type_label[i],"Tipo de média",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_desvio_x,montar_desvio_y+44,montar_desvio_w,16))
                  return(false);
               m_tab8_montar_desvio_ma_type_label[i].FontSize(9);
               m_tab8_montar_desvio_ma_type_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_desvio_ma_type_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_desvio_ma_type_combo[i]);
               m_tab8_montar_desvio_ma_type_combo[i].XSize(montar_desvio_w);
               m_tab8_montar_desvio_ma_type_combo[i].YSize(montar_desvio_h);
               m_tab8_montar_desvio_ma_type_combo[i].BackColor(clrWhite);
               m_tab8_montar_desvio_ma_type_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_desvio_ma_type_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_desvio_ma_type_combo[i].BorderColor(tab2_border);
               m_tab8_montar_desvio_ma_type_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_desvio_ma_type_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_desvio_ma_type_combo[i].FontSize(10);
               m_tab8_montar_desvio_ma_type_combo[i].ItemsTotal(ArraySize(montar_ma_type_items));
               m_tab8_montar_desvio_ma_type_combo[i].CheckBoxMode(false);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().XSize(montar_desvio_w-2);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().YSize(montar_desvio_h);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().IconXGap((montar_desvio_w-2)-18);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_desvio_ma_type_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_ma_type_items);m++) m_tab8_montar_desvio_ma_type_combo[i].SetValue(m,montar_ma_type_items[m]);
               m_tab8_montar_desvio_ma_type_combo[i].GetListViewPointer().YSize(140);
               m_tab8_montar_desvio_ma_type_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_desvio_ma_type_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_desvio_ma_type_combo[i].CreateComboBox("",montar_desvio_x,montar_desvio_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_desvio_ma_type_combo[i]);
               m_tab8_montar_desvio_ma_type_combo[i].SelectItem(0);

               if(!CreateTextLabel(m_tab8_montar_desvio_price_label[i],"Modo de preço",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_desvio_x,montar_desvio_y+88,montar_desvio_w,16))
                  return(false);
               m_tab8_montar_desvio_price_label[i].FontSize(9);
               m_tab8_montar_desvio_price_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_desvio_price_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_desvio_price_combo[i]);
               m_tab8_montar_desvio_price_combo[i].XSize(montar_desvio_w);
               m_tab8_montar_desvio_price_combo[i].YSize(montar_desvio_h);
               m_tab8_montar_desvio_price_combo[i].BackColor(clrWhite);
               m_tab8_montar_desvio_price_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_desvio_price_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_desvio_price_combo[i].BorderColor(tab2_border);
               m_tab8_montar_desvio_price_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_desvio_price_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_desvio_price_combo[i].FontSize(10);
               m_tab8_montar_desvio_price_combo[i].ItemsTotal(ArraySize(montar_price_items));
               m_tab8_montar_desvio_price_combo[i].CheckBoxMode(false);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().XSize(montar_desvio_w-2);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().YSize(montar_desvio_h);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().IconXGap((montar_desvio_w-2)-18);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_desvio_price_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_price_items);m++) m_tab8_montar_desvio_price_combo[i].SetValue(m,montar_price_items[m]);
               m_tab8_montar_desvio_price_combo[i].GetListViewPointer().YSize(160);
               m_tab8_montar_desvio_price_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_desvio_price_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_desvio_price_combo[i].CreateComboBox("",montar_desvio_x,montar_desvio_y+104))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_desvio_price_combo[i]);
               m_tab8_montar_desvio_price_combo[i].SelectItem(0);
              }
            else if(p==5)
              {
               const int montar_atr_x=12;
               const int montar_atr_title_y=8;
               const int montar_atr_y=28;
               const int montar_atr_w=montar_param_card_w-48;
               const int montar_atr_spin_edit_w=montar_atr_w-34;
               const string montar_atr_title=(string)(i+1)+" canal atr";

               if(!CreateTextLabel(m_tab8_montar_atr_title[i],montar_atr_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_atr_x,montar_atr_title_y,montar_atr_w,16))
                  return(false);
               m_tab8_montar_atr_title[i].FontSize(9);
               m_tab8_montar_atr_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_atr_period_label[i],"Período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_atr_x,montar_atr_y,montar_atr_w,16))
                  return(false);
               m_tab8_montar_atr_period_label[i].FontSize(9);
               m_tab8_montar_atr_period_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_atr_period_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_atr_period_spin[i]);
               m_tab8_montar_atr_period_spin[i].XSize(montar_atr_w);
               m_tab8_montar_atr_period_spin[i].MaxValue(9999.0);
               m_tab8_montar_atr_period_spin[i].MinValue(1.0);
               m_tab8_montar_atr_period_spin[i].StepValue(1.0);
               m_tab8_montar_atr_period_spin[i].SetDigits(0);
               m_tab8_montar_atr_period_spin[i].SpinEditMode(true);
               m_tab8_montar_atr_period_spin[i].CheckBoxMode(false);
               m_tab8_montar_atr_period_spin[i].SetValue("14");
               m_tab8_montar_atr_period_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_atr_period_spin[i].GetTextBoxPointer().XSize(montar_atr_spin_edit_w);
               m_tab8_montar_atr_period_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_atr_period_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_atr_period_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_atr_period_spin[i].CreateTextEdit("",montar_atr_x,montar_atr_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_atr_period_spin[i]);
               m_tab8_montar_atr_period_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_atr_period_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_atr_period_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_atr_period_spin[i].BorderColor(tab2_border);
               m_tab8_montar_atr_period_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_atr_period_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_atr_period_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_atr_period_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_atr_period_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_atr_period_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_atr_period_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_atr_period_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_atr_deviation_label[i],"Desvios",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_atr_x,montar_atr_y+44,montar_atr_w,16))
                  return(false);
               m_tab8_montar_atr_deviation_label[i].FontSize(9);
               m_tab8_montar_atr_deviation_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_atr_deviation_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_atr_deviation_spin[i]);
               m_tab8_montar_atr_deviation_spin[i].XSize(montar_atr_w);
               m_tab8_montar_atr_deviation_spin[i].MaxValue(9999.0);
               m_tab8_montar_atr_deviation_spin[i].MinValue(0.0);
               m_tab8_montar_atr_deviation_spin[i].StepValue(1.0);
               m_tab8_montar_atr_deviation_spin[i].SetDigits(0);
               m_tab8_montar_atr_deviation_spin[i].SpinEditMode(true);
               m_tab8_montar_atr_deviation_spin[i].CheckBoxMode(false);
               m_tab8_montar_atr_deviation_spin[i].SetValue("0");
               m_tab8_montar_atr_deviation_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_atr_deviation_spin[i].GetTextBoxPointer().XSize(montar_atr_spin_edit_w);
               m_tab8_montar_atr_deviation_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_atr_deviation_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_atr_deviation_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_atr_deviation_spin[i].CreateTextEdit("",montar_atr_x,montar_atr_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_atr_deviation_spin[i]);
               m_tab8_montar_atr_deviation_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_atr_deviation_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_atr_deviation_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_atr_deviation_spin[i].BorderColor(tab2_border);
               m_tab8_montar_atr_deviation_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_atr_deviation_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_atr_deviation_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_atr_deviation_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_atr_deviation_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_atr_deviation_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_atr_deviation_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_atr_deviation_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);
              }
            else if(p==6)
              {
               const int montar_media_x=12;
               const int montar_media_title_y=8;
               const int montar_media_y=28;
               const int montar_media_w=montar_param_card_w-48;
               const int montar_media_h=20;
               const int montar_media_spin_edit_w=montar_media_w-34;
               const string montar_media_title=(string)(i+1)+" media movel";

               if(!CreateTextLabel(m_tab8_montar_media_title[i],montar_media_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_media_x,montar_media_title_y,montar_media_w,16))
                  return(false);
               m_tab8_montar_media_title[i].FontSize(9);
               m_tab8_montar_media_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_media_period_label[i],"Período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_media_x,montar_media_y,montar_media_w,16))
                  return(false);
               m_tab8_montar_media_period_label[i].FontSize(9);
               m_tab8_montar_media_period_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_media_period_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_media_period_spin[i]);
               m_tab8_montar_media_period_spin[i].XSize(montar_media_w);
               m_tab8_montar_media_period_spin[i].MaxValue(9999.0);
               m_tab8_montar_media_period_spin[i].MinValue(1.0);
               m_tab8_montar_media_period_spin[i].StepValue(1.0);
               m_tab8_montar_media_period_spin[i].SetDigits(0);
               m_tab8_montar_media_period_spin[i].SpinEditMode(true);
               m_tab8_montar_media_period_spin[i].CheckBoxMode(false);
               m_tab8_montar_media_period_spin[i].SetValue("14");
               m_tab8_montar_media_period_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_media_period_spin[i].GetTextBoxPointer().XSize(montar_media_spin_edit_w);
               m_tab8_montar_media_period_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_media_period_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_media_period_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_media_period_spin[i].CreateTextEdit("",montar_media_x,montar_media_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_media_period_spin[i]);
               m_tab8_montar_media_period_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_media_period_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_media_period_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_media_period_spin[i].BorderColor(tab2_border);
               m_tab8_montar_media_period_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_media_period_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_media_period_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_media_period_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_media_period_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_media_period_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_media_period_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_media_period_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_media_shift_label[i],"Deslocamento",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_media_x,montar_media_y+44,montar_media_w,16))
                  return(false);
               m_tab8_montar_media_shift_label[i].FontSize(9);
               m_tab8_montar_media_shift_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_media_shift_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_media_shift_spin[i]);
               m_tab8_montar_media_shift_spin[i].XSize(montar_media_w);
               m_tab8_montar_media_shift_spin[i].MaxValue(9999.0);
               m_tab8_montar_media_shift_spin[i].MinValue(0.0);
               m_tab8_montar_media_shift_spin[i].StepValue(1.0);
               m_tab8_montar_media_shift_spin[i].SetDigits(0);
               m_tab8_montar_media_shift_spin[i].SpinEditMode(true);
               m_tab8_montar_media_shift_spin[i].CheckBoxMode(false);
               m_tab8_montar_media_shift_spin[i].SetValue("0");
               m_tab8_montar_media_shift_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_media_shift_spin[i].GetTextBoxPointer().XSize(montar_media_spin_edit_w);
               m_tab8_montar_media_shift_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_media_shift_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_media_shift_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_media_shift_spin[i].CreateTextEdit("",montar_media_x,montar_media_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_media_shift_spin[i]);
               m_tab8_montar_media_shift_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_media_shift_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_media_shift_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_media_shift_spin[i].BorderColor(tab2_border);
               m_tab8_montar_media_shift_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_media_shift_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_media_shift_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_media_shift_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_media_shift_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_media_shift_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_media_shift_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_media_shift_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_media_ma_type_label[i],"Tipo de média",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_media_x,montar_media_y+88,montar_media_w,16))
                  return(false);
               m_tab8_montar_media_ma_type_label[i].FontSize(9);
               m_tab8_montar_media_ma_type_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_media_ma_type_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_media_ma_type_combo[i]);
               m_tab8_montar_media_ma_type_combo[i].XSize(montar_media_w);
               m_tab8_montar_media_ma_type_combo[i].YSize(montar_media_h);
               m_tab8_montar_media_ma_type_combo[i].BackColor(clrWhite);
               m_tab8_montar_media_ma_type_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_media_ma_type_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_media_ma_type_combo[i].BorderColor(tab2_border);
               m_tab8_montar_media_ma_type_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_media_ma_type_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_media_ma_type_combo[i].FontSize(10);
               m_tab8_montar_media_ma_type_combo[i].ItemsTotal(ArraySize(montar_ma_type_items));
               m_tab8_montar_media_ma_type_combo[i].CheckBoxMode(false);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().XSize(montar_media_w-2);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().YSize(montar_media_h);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().IconXGap((montar_media_w-2)-18);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_media_ma_type_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_ma_type_items);m++) m_tab8_montar_media_ma_type_combo[i].SetValue(m,montar_ma_type_items[m]);
               m_tab8_montar_media_ma_type_combo[i].GetListViewPointer().YSize(140);
               m_tab8_montar_media_ma_type_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_media_ma_type_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_media_ma_type_combo[i].CreateComboBox("",montar_media_x,montar_media_y+104))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_media_ma_type_combo[i]);
               m_tab8_montar_media_ma_type_combo[i].SelectItem(0);

               if(!CreateTextLabel(m_tab8_montar_media_price_label[i],"Modo de preço",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_media_x,montar_media_y+132,montar_media_w,16))
                  return(false);
               m_tab8_montar_media_price_label[i].FontSize(9);
               m_tab8_montar_media_price_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_media_price_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_media_price_combo[i]);
               m_tab8_montar_media_price_combo[i].XSize(montar_media_w);
               m_tab8_montar_media_price_combo[i].YSize(montar_media_h);
               m_tab8_montar_media_price_combo[i].BackColor(clrWhite);
               m_tab8_montar_media_price_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_media_price_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_media_price_combo[i].BorderColor(tab2_border);
               m_tab8_montar_media_price_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_media_price_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_media_price_combo[i].FontSize(10);
               m_tab8_montar_media_price_combo[i].ItemsTotal(ArraySize(montar_price_items));
               m_tab8_montar_media_price_combo[i].CheckBoxMode(false);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().XSize(montar_media_w-2);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().YSize(montar_media_h);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().IconXGap((montar_media_w-2)-18);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_media_price_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_price_items);m++) m_tab8_montar_media_price_combo[i].SetValue(m,montar_price_items[m]);
               m_tab8_montar_media_price_combo[i].GetListViewPointer().YSize(160);
               m_tab8_montar_media_price_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_media_price_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_media_price_combo[i].CreateComboBox("",montar_media_x,montar_media_y+148))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_media_price_combo[i]);
               m_tab8_montar_media_price_combo[i].SelectItem(0);
              }
            else if(p==7)
              {
               const int montar_bandas_x=12;
               const int montar_bandas_title_y=8;
               const int montar_bandas_y=28;
               const int montar_bandas_w=montar_param_card_w-48;
               const int montar_bandas_h=20;
               const int montar_bandas_spin_edit_w=montar_bandas_w-34;
               const string montar_bandas_title=(string)(i+1)+" bandas bolinger";

               if(!CreateTextLabel(m_tab8_montar_bandas_title[i],montar_bandas_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_bandas_x,montar_bandas_title_y,montar_bandas_w,16))
                  return(false);
               m_tab8_montar_bandas_title[i].FontSize(9);
               m_tab8_montar_bandas_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_bandas_period_label[i],"Período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_bandas_x,montar_bandas_y,montar_bandas_w,16))
                  return(false);
               m_tab8_montar_bandas_period_label[i].FontSize(9);
               m_tab8_montar_bandas_period_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_bandas_period_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_bandas_period_spin[i]);
               m_tab8_montar_bandas_period_spin[i].XSize(montar_bandas_w);
               m_tab8_montar_bandas_period_spin[i].MaxValue(9999.0);
               m_tab8_montar_bandas_period_spin[i].MinValue(1.0);
               m_tab8_montar_bandas_period_spin[i].StepValue(1.0);
               m_tab8_montar_bandas_period_spin[i].SetDigits(0);
               m_tab8_montar_bandas_period_spin[i].SpinEditMode(true);
               m_tab8_montar_bandas_period_spin[i].CheckBoxMode(false);
               m_tab8_montar_bandas_period_spin[i].SetValue("14");
               m_tab8_montar_bandas_period_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_bandas_period_spin[i].GetTextBoxPointer().XSize(montar_bandas_spin_edit_w);
               m_tab8_montar_bandas_period_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_bandas_period_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_bandas_period_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_bandas_period_spin[i].CreateTextEdit("",montar_bandas_x,montar_bandas_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_bandas_period_spin[i]);
               m_tab8_montar_bandas_period_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_bandas_period_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_bandas_period_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_bandas_period_spin[i].BorderColor(tab2_border);
               m_tab8_montar_bandas_period_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_bandas_period_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_bandas_period_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_bandas_period_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_bandas_period_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_bandas_period_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_bandas_period_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_bandas_period_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_bandas_deviation_label[i],"Desvio",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_bandas_x,montar_bandas_y+44,montar_bandas_w,16))
                  return(false);
               m_tab8_montar_bandas_deviation_label[i].FontSize(9);
               m_tab8_montar_bandas_deviation_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_bandas_deviation_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_bandas_deviation_spin[i]);
               m_tab8_montar_bandas_deviation_spin[i].XSize(montar_bandas_w);
               m_tab8_montar_bandas_deviation_spin[i].MaxValue(9999.0);
               m_tab8_montar_bandas_deviation_spin[i].MinValue(0.0);
               m_tab8_montar_bandas_deviation_spin[i].StepValue(1.0);
               m_tab8_montar_bandas_deviation_spin[i].SetDigits(0);
               m_tab8_montar_bandas_deviation_spin[i].SpinEditMode(true);
               m_tab8_montar_bandas_deviation_spin[i].CheckBoxMode(false);
               m_tab8_montar_bandas_deviation_spin[i].SetValue("0");
               m_tab8_montar_bandas_deviation_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_bandas_deviation_spin[i].GetTextBoxPointer().XSize(montar_bandas_spin_edit_w);
               m_tab8_montar_bandas_deviation_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_bandas_deviation_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_bandas_deviation_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_bandas_deviation_spin[i].CreateTextEdit("",montar_bandas_x,montar_bandas_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_bandas_deviation_spin[i]);
               m_tab8_montar_bandas_deviation_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_bandas_deviation_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_bandas_deviation_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_bandas_deviation_spin[i].BorderColor(tab2_border);
               m_tab8_montar_bandas_deviation_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_bandas_deviation_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_bandas_deviation_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_bandas_deviation_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_bandas_deviation_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_bandas_deviation_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_bandas_deviation_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_bandas_deviation_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_bandas_shift_label[i],"Deslocamento",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_bandas_x,montar_bandas_y+88,montar_bandas_w,16))
                  return(false);
               m_tab8_montar_bandas_shift_label[i].FontSize(9);
               m_tab8_montar_bandas_shift_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_bandas_shift_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_bandas_shift_spin[i]);
               m_tab8_montar_bandas_shift_spin[i].XSize(montar_bandas_w);
               m_tab8_montar_bandas_shift_spin[i].MaxValue(9999.0);
               m_tab8_montar_bandas_shift_spin[i].MinValue(0.0);
               m_tab8_montar_bandas_shift_spin[i].StepValue(1.0);
               m_tab8_montar_bandas_shift_spin[i].SetDigits(0);
               m_tab8_montar_bandas_shift_spin[i].SpinEditMode(true);
               m_tab8_montar_bandas_shift_spin[i].CheckBoxMode(false);
               m_tab8_montar_bandas_shift_spin[i].SetValue("0");
               m_tab8_montar_bandas_shift_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_bandas_shift_spin[i].GetTextBoxPointer().XSize(montar_bandas_spin_edit_w);
               m_tab8_montar_bandas_shift_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_bandas_shift_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_bandas_shift_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_bandas_shift_spin[i].CreateTextEdit("",montar_bandas_x,montar_bandas_y+104))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_bandas_shift_spin[i]);
               m_tab8_montar_bandas_shift_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_bandas_shift_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_bandas_shift_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_bandas_shift_spin[i].BorderColor(tab2_border);
               m_tab8_montar_bandas_shift_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_bandas_shift_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_bandas_shift_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_bandas_shift_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_bandas_shift_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_bandas_shift_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_bandas_shift_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_bandas_shift_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_bandas_price_label[i],"Modo de preço",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_bandas_x,montar_bandas_y+132,montar_bandas_w,16))
                  return(false);
               m_tab8_montar_bandas_price_label[i].FontSize(9);
               m_tab8_montar_bandas_price_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_bandas_price_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_bandas_price_combo[i]);
               m_tab8_montar_bandas_price_combo[i].XSize(montar_bandas_w);
               m_tab8_montar_bandas_price_combo[i].YSize(montar_bandas_h);
               m_tab8_montar_bandas_price_combo[i].BackColor(clrWhite);
               m_tab8_montar_bandas_price_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_bandas_price_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_bandas_price_combo[i].BorderColor(tab2_border);
               m_tab8_montar_bandas_price_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_bandas_price_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_bandas_price_combo[i].FontSize(10);
               m_tab8_montar_bandas_price_combo[i].ItemsTotal(ArraySize(montar_price_items));
               m_tab8_montar_bandas_price_combo[i].CheckBoxMode(false);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().XSize(montar_bandas_w-2);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().YSize(montar_bandas_h);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().IconXGap((montar_bandas_w-2)-18);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_bandas_price_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_price_items);m++) m_tab8_montar_bandas_price_combo[i].SetValue(m,montar_price_items[m]);
               m_tab8_montar_bandas_price_combo[i].GetListViewPointer().YSize(160);
               m_tab8_montar_bandas_price_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_bandas_price_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_bandas_price_combo[i].CreateComboBox("",montar_bandas_x,montar_bandas_y+148))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_bandas_price_combo[i]);
               m_tab8_montar_bandas_price_combo[i].SelectItem(0);
              }
            else if(p==8)
              {
               const int montar_macd_x=12;
               const int montar_macd_title_y=8;
               const int montar_macd_y=28;
               const int montar_macd_w=montar_param_card_w-48;
               const int montar_macd_h=20;
               const int montar_macd_spin_edit_w=montar_macd_w-34;
               const string montar_macd_title=(string)(i+1)+" macd";

               if(!CreateTextLabel(m_tab8_montar_macd_title[i],montar_macd_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_macd_x,montar_macd_title_y,montar_macd_w,16))
                  return(false);
               m_tab8_montar_macd_title[i].FontSize(9);
               m_tab8_montar_macd_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_macd_fast_label[i],"EMA rápida",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_macd_x,montar_macd_y,montar_macd_w,16))
                  return(false);
               m_tab8_montar_macd_fast_label[i].FontSize(9);
               m_tab8_montar_macd_fast_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_macd_fast_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_macd_fast_spin[i]);
               m_tab8_montar_macd_fast_spin[i].XSize(montar_macd_w);
               m_tab8_montar_macd_fast_spin[i].MaxValue(9999.0);
               m_tab8_montar_macd_fast_spin[i].MinValue(0.0);
               m_tab8_montar_macd_fast_spin[i].StepValue(1.0);
               m_tab8_montar_macd_fast_spin[i].SetDigits(0);
               m_tab8_montar_macd_fast_spin[i].SpinEditMode(true);
               m_tab8_montar_macd_fast_spin[i].CheckBoxMode(false);
               m_tab8_montar_macd_fast_spin[i].SetValue("14");
               m_tab8_montar_macd_fast_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_macd_fast_spin[i].GetTextBoxPointer().XSize(montar_macd_spin_edit_w);
               m_tab8_montar_macd_fast_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_macd_fast_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_macd_fast_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_macd_fast_spin[i].CreateTextEdit("",montar_macd_x,montar_macd_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_macd_fast_spin[i]);
               m_tab8_montar_macd_fast_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_macd_fast_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_macd_fast_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_macd_fast_spin[i].BorderColor(tab2_border);
               m_tab8_montar_macd_fast_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_macd_fast_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_macd_fast_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_macd_fast_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_macd_fast_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_macd_fast_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_macd_fast_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_macd_fast_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_macd_slow_label[i],"EMA lenta",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_macd_x,montar_macd_y+44,montar_macd_w,16))
                  return(false);
               m_tab8_montar_macd_slow_label[i].FontSize(9);
               m_tab8_montar_macd_slow_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_macd_slow_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_macd_slow_spin[i]);
               m_tab8_montar_macd_slow_spin[i].XSize(montar_macd_w);
               m_tab8_montar_macd_slow_spin[i].MaxValue(9999.0);
               m_tab8_montar_macd_slow_spin[i].MinValue(0.0);
               m_tab8_montar_macd_slow_spin[i].StepValue(1.0);
               m_tab8_montar_macd_slow_spin[i].SetDigits(0);
               m_tab8_montar_macd_slow_spin[i].SpinEditMode(true);
               m_tab8_montar_macd_slow_spin[i].CheckBoxMode(false);
               m_tab8_montar_macd_slow_spin[i].SetValue("0");
               m_tab8_montar_macd_slow_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_macd_slow_spin[i].GetTextBoxPointer().XSize(montar_macd_spin_edit_w);
               m_tab8_montar_macd_slow_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_macd_slow_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_macd_slow_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_macd_slow_spin[i].CreateTextEdit("",montar_macd_x,montar_macd_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_macd_slow_spin[i]);
               m_tab8_montar_macd_slow_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_macd_slow_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_macd_slow_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_macd_slow_spin[i].BorderColor(tab2_border);
               m_tab8_montar_macd_slow_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_macd_slow_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_macd_slow_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_macd_slow_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_macd_slow_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_macd_slow_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_macd_slow_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_macd_slow_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_macd_signal_label[i],"Sinal",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_macd_x,montar_macd_y+88,montar_macd_w,16))
                  return(false);
               m_tab8_montar_macd_signal_label[i].FontSize(9);
               m_tab8_montar_macd_signal_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_macd_signal_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_macd_signal_spin[i]);
               m_tab8_montar_macd_signal_spin[i].XSize(montar_macd_w);
               m_tab8_montar_macd_signal_spin[i].MaxValue(9999.0);
               m_tab8_montar_macd_signal_spin[i].MinValue(0.0);
               m_tab8_montar_macd_signal_spin[i].StepValue(1.0);
               m_tab8_montar_macd_signal_spin[i].SetDigits(0);
               m_tab8_montar_macd_signal_spin[i].SpinEditMode(true);
               m_tab8_montar_macd_signal_spin[i].CheckBoxMode(false);
               m_tab8_montar_macd_signal_spin[i].SetValue("0");
               m_tab8_montar_macd_signal_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_macd_signal_spin[i].GetTextBoxPointer().XSize(montar_macd_spin_edit_w);
               m_tab8_montar_macd_signal_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_macd_signal_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_macd_signal_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_macd_signal_spin[i].CreateTextEdit("",montar_macd_x,montar_macd_y+104))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_macd_signal_spin[i]);
               m_tab8_montar_macd_signal_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_macd_signal_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_macd_signal_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_macd_signal_spin[i].BorderColor(tab2_border);
               m_tab8_montar_macd_signal_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_macd_signal_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_macd_signal_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_macd_signal_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_macd_signal_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_macd_signal_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_macd_signal_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_macd_signal_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_macd_price_label[i],"Modo de preço",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_macd_x,montar_macd_y+132,montar_macd_w,16))
                  return(false);
               m_tab8_montar_macd_price_label[i].FontSize(9);
               m_tab8_montar_macd_price_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_macd_price_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_macd_price_combo[i]);
               m_tab8_montar_macd_price_combo[i].XSize(montar_macd_w);
               m_tab8_montar_macd_price_combo[i].YSize(montar_macd_h);
               m_tab8_montar_macd_price_combo[i].BackColor(clrWhite);
               m_tab8_montar_macd_price_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_macd_price_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_macd_price_combo[i].BorderColor(tab2_border);
               m_tab8_montar_macd_price_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_macd_price_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_macd_price_combo[i].FontSize(10);
               m_tab8_montar_macd_price_combo[i].ItemsTotal(ArraySize(montar_price_items));
               m_tab8_montar_macd_price_combo[i].CheckBoxMode(false);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().XSize(montar_macd_w-2);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().YSize(montar_macd_h);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().IconXGap((montar_macd_w-2)-18);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_macd_price_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_price_items);m++) m_tab8_montar_macd_price_combo[i].SetValue(m,montar_price_items[m]);
               m_tab8_montar_macd_price_combo[i].GetListViewPointer().YSize(160);
               m_tab8_montar_macd_price_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_macd_price_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_macd_price_combo[i].CreateComboBox("",montar_macd_x,montar_macd_y+148))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_macd_price_combo[i]);
               m_tab8_montar_macd_price_combo[i].SelectItem(0);
              }
            else if(p==9)
              {
               const int montar_env_x=12;
               const int montar_env_title_y=8;
               const int montar_env_y=28;
               const int montar_env_w=montar_param_card_w-48;
               const int montar_env_h=20;
               const int montar_env_spin_edit_w=montar_env_w-34;
               const string montar_env_title=(string)(i+1)+" envelopes";

               if(!CreateTextLabel(m_tab8_montar_envelopes_title[i],montar_env_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_env_x,montar_env_title_y,montar_env_w,16))
                  return(false);
               m_tab8_montar_envelopes_title[i].FontSize(9);
               m_tab8_montar_envelopes_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_envelopes_period_label[i],"Período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_env_x,montar_env_y,montar_env_w,16))
                  return(false);
               m_tab8_montar_envelopes_period_label[i].FontSize(9);
               m_tab8_montar_envelopes_period_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_envelopes_period_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_envelopes_period_spin[i]);
               m_tab8_montar_envelopes_period_spin[i].XSize(montar_env_w);
               m_tab8_montar_envelopes_period_spin[i].MaxValue(9999.0);
               m_tab8_montar_envelopes_period_spin[i].MinValue(1.0);
               m_tab8_montar_envelopes_period_spin[i].StepValue(1.0);
               m_tab8_montar_envelopes_period_spin[i].SetDigits(0);
               m_tab8_montar_envelopes_period_spin[i].SpinEditMode(true);
               m_tab8_montar_envelopes_period_spin[i].CheckBoxMode(false);
               m_tab8_montar_envelopes_period_spin[i].SetValue("14");
               m_tab8_montar_envelopes_period_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_envelopes_period_spin[i].GetTextBoxPointer().XSize(montar_env_spin_edit_w);
               m_tab8_montar_envelopes_period_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_envelopes_period_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_envelopes_period_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_envelopes_period_spin[i].CreateTextEdit("",montar_env_x,montar_env_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_envelopes_period_spin[i]);
               m_tab8_montar_envelopes_period_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_envelopes_period_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_envelopes_period_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_envelopes_period_spin[i].BorderColor(tab2_border);
               m_tab8_montar_envelopes_period_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_envelopes_period_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_envelopes_period_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_envelopes_period_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_envelopes_period_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_envelopes_period_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_envelopes_period_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_envelopes_period_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_envelopes_shift_label[i],"Deslocamento",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_env_x,montar_env_y+44,montar_env_w,16))
                  return(false);
               m_tab8_montar_envelopes_shift_label[i].FontSize(9);
               m_tab8_montar_envelopes_shift_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_envelopes_shift_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_envelopes_shift_spin[i]);
               m_tab8_montar_envelopes_shift_spin[i].XSize(montar_env_w);
               m_tab8_montar_envelopes_shift_spin[i].MaxValue(9999.0);
               m_tab8_montar_envelopes_shift_spin[i].MinValue(0.0);
               m_tab8_montar_envelopes_shift_spin[i].StepValue(1.0);
               m_tab8_montar_envelopes_shift_spin[i].SetDigits(0);
               m_tab8_montar_envelopes_shift_spin[i].SpinEditMode(true);
               m_tab8_montar_envelopes_shift_spin[i].CheckBoxMode(false);
               m_tab8_montar_envelopes_shift_spin[i].SetValue("0");
               m_tab8_montar_envelopes_shift_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_envelopes_shift_spin[i].GetTextBoxPointer().XSize(montar_env_spin_edit_w);
               m_tab8_montar_envelopes_shift_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_envelopes_shift_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_envelopes_shift_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_envelopes_shift_spin[i].CreateTextEdit("",montar_env_x,montar_env_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_envelopes_shift_spin[i]);
               m_tab8_montar_envelopes_shift_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_envelopes_shift_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_envelopes_shift_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_envelopes_shift_spin[i].BorderColor(tab2_border);
               m_tab8_montar_envelopes_shift_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_envelopes_shift_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_envelopes_shift_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_envelopes_shift_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_envelopes_shift_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_envelopes_shift_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_envelopes_shift_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_envelopes_shift_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_envelopes_ma_type_label[i],"Tipo de média",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_env_x,montar_env_y+88,montar_env_w,16))
                  return(false);
               m_tab8_montar_envelopes_ma_type_label[i].FontSize(9);
               m_tab8_montar_envelopes_ma_type_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_envelopes_ma_type_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_envelopes_ma_type_combo[i]);
               m_tab8_montar_envelopes_ma_type_combo[i].XSize(montar_env_w);
               m_tab8_montar_envelopes_ma_type_combo[i].YSize(montar_env_h);
               m_tab8_montar_envelopes_ma_type_combo[i].BackColor(clrWhite);
               m_tab8_montar_envelopes_ma_type_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_envelopes_ma_type_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_envelopes_ma_type_combo[i].BorderColor(tab2_border);
               m_tab8_montar_envelopes_ma_type_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_envelopes_ma_type_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_envelopes_ma_type_combo[i].FontSize(10);
               m_tab8_montar_envelopes_ma_type_combo[i].ItemsTotal(ArraySize(montar_ma_type_items));
               m_tab8_montar_envelopes_ma_type_combo[i].CheckBoxMode(false);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().XSize(montar_env_w-2);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().YSize(montar_env_h);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().IconXGap((montar_env_w-2)-18);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_envelopes_ma_type_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_ma_type_items);m++) m_tab8_montar_envelopes_ma_type_combo[i].SetValue(m,montar_ma_type_items[m]);
               m_tab8_montar_envelopes_ma_type_combo[i].GetListViewPointer().YSize(140);
               m_tab8_montar_envelopes_ma_type_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_envelopes_ma_type_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_envelopes_ma_type_combo[i].CreateComboBox("",montar_env_x,montar_env_y+104))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_envelopes_ma_type_combo[i]);
               m_tab8_montar_envelopes_ma_type_combo[i].SelectItem(0);

               if(!CreateTextLabel(m_tab8_montar_envelopes_deviation_label[i],"Desvio",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_env_x,montar_env_y+132,montar_env_w,16))
                  return(false);
               m_tab8_montar_envelopes_deviation_label[i].FontSize(9);
               m_tab8_montar_envelopes_deviation_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_envelopes_deviation_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_envelopes_deviation_spin[i]);
               m_tab8_montar_envelopes_deviation_spin[i].XSize(montar_env_w);
               m_tab8_montar_envelopes_deviation_spin[i].MaxValue(9999.0);
               m_tab8_montar_envelopes_deviation_spin[i].MinValue(0.0);
               m_tab8_montar_envelopes_deviation_spin[i].StepValue(1.0);
               m_tab8_montar_envelopes_deviation_spin[i].SetDigits(0);
               m_tab8_montar_envelopes_deviation_spin[i].SpinEditMode(true);
               m_tab8_montar_envelopes_deviation_spin[i].CheckBoxMode(false);
               m_tab8_montar_envelopes_deviation_spin[i].SetValue("1");
               m_tab8_montar_envelopes_deviation_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_envelopes_deviation_spin[i].GetTextBoxPointer().XSize(montar_env_spin_edit_w);
               m_tab8_montar_envelopes_deviation_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_envelopes_deviation_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_envelopes_deviation_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_envelopes_deviation_spin[i].CreateTextEdit("",montar_env_x,montar_env_y+148))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_envelopes_deviation_spin[i]);
               m_tab8_montar_envelopes_deviation_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_envelopes_deviation_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_envelopes_deviation_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_envelopes_deviation_spin[i].BorderColor(tab2_border);
               m_tab8_montar_envelopes_deviation_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_envelopes_deviation_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_envelopes_deviation_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_envelopes_deviation_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_envelopes_deviation_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_envelopes_deviation_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_envelopes_deviation_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_envelopes_deviation_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);
              }
            else if(p==10)
              {
               const int montar_stoch_x=12;
               const int montar_stoch_title_y=8;
               const int montar_stoch_y=28;
               const int montar_stoch_w=montar_param_card_w-48;
               const int montar_stoch_h=20;
               const int montar_stoch_spin_edit_w=montar_stoch_w-34;
               const string montar_stoch_title=(string)(i+1)+" estocastico";

               if(!CreateTextLabel(m_tab8_montar_stoch_title[i],montar_stoch_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_stoch_x,montar_stoch_title_y,montar_stoch_w,16))
                  return(false);
               m_tab8_montar_stoch_title[i].FontSize(9);
               m_tab8_montar_stoch_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_stoch_k_label[i],"K período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_stoch_x,montar_stoch_y,montar_stoch_w,16))
                  return(false);
               m_tab8_montar_stoch_k_label[i].FontSize(9);
               m_tab8_montar_stoch_k_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_stoch_k_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_stoch_k_spin[i]);
               m_tab8_montar_stoch_k_spin[i].XSize(montar_stoch_w);
               m_tab8_montar_stoch_k_spin[i].MaxValue(9999.0);
               m_tab8_montar_stoch_k_spin[i].MinValue(0.0);
               m_tab8_montar_stoch_k_spin[i].StepValue(1.0);
               m_tab8_montar_stoch_k_spin[i].SetDigits(0);
               m_tab8_montar_stoch_k_spin[i].SpinEditMode(true);
               m_tab8_montar_stoch_k_spin[i].CheckBoxMode(false);
               m_tab8_montar_stoch_k_spin[i].SetValue("5");
               m_tab8_montar_stoch_k_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_stoch_k_spin[i].GetTextBoxPointer().XSize(montar_stoch_spin_edit_w);
               m_tab8_montar_stoch_k_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_stoch_k_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_stoch_k_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_stoch_k_spin[i].CreateTextEdit("",montar_stoch_x,montar_stoch_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_stoch_k_spin[i]);
               m_tab8_montar_stoch_k_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_stoch_k_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_stoch_k_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_stoch_k_spin[i].BorderColor(tab2_border);
               m_tab8_montar_stoch_k_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_stoch_k_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_stoch_k_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_stoch_k_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_stoch_k_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_stoch_k_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_stoch_k_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_stoch_k_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_stoch_d_label[i],"D período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_stoch_x,montar_stoch_y+44,montar_stoch_w,16))
                  return(false);
               m_tab8_montar_stoch_d_label[i].FontSize(9);
               m_tab8_montar_stoch_d_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_stoch_d_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_stoch_d_spin[i]);
               m_tab8_montar_stoch_d_spin[i].XSize(montar_stoch_w);
               m_tab8_montar_stoch_d_spin[i].MaxValue(9999.0);
               m_tab8_montar_stoch_d_spin[i].MinValue(0.0);
               m_tab8_montar_stoch_d_spin[i].StepValue(1.0);
               m_tab8_montar_stoch_d_spin[i].SetDigits(0);
               m_tab8_montar_stoch_d_spin[i].SpinEditMode(true);
               m_tab8_montar_stoch_d_spin[i].CheckBoxMode(false);
               m_tab8_montar_stoch_d_spin[i].SetValue("3");
               m_tab8_montar_stoch_d_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_stoch_d_spin[i].GetTextBoxPointer().XSize(montar_stoch_spin_edit_w);
               m_tab8_montar_stoch_d_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_stoch_d_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_stoch_d_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_stoch_d_spin[i].CreateTextEdit("",montar_stoch_x,montar_stoch_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_stoch_d_spin[i]);
               m_tab8_montar_stoch_d_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_stoch_d_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_stoch_d_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_stoch_d_spin[i].BorderColor(tab2_border);
               m_tab8_montar_stoch_d_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_stoch_d_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_stoch_d_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_stoch_d_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_stoch_d_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_stoch_d_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_stoch_d_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_stoch_d_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_stoch_slow_label[i],"Lentidão",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_stoch_x,montar_stoch_y+88,montar_stoch_w,16))
                  return(false);
               m_tab8_montar_stoch_slow_label[i].FontSize(9);
               m_tab8_montar_stoch_slow_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_stoch_slow_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_stoch_slow_spin[i]);
               m_tab8_montar_stoch_slow_spin[i].XSize(montar_stoch_w);
               m_tab8_montar_stoch_slow_spin[i].MaxValue(9999.0);
               m_tab8_montar_stoch_slow_spin[i].MinValue(0.0);
               m_tab8_montar_stoch_slow_spin[i].StepValue(1.0);
               m_tab8_montar_stoch_slow_spin[i].SetDigits(0);
               m_tab8_montar_stoch_slow_spin[i].SpinEditMode(true);
               m_tab8_montar_stoch_slow_spin[i].CheckBoxMode(false);
               m_tab8_montar_stoch_slow_spin[i].SetValue("3");
               m_tab8_montar_stoch_slow_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_stoch_slow_spin[i].GetTextBoxPointer().XSize(montar_stoch_spin_edit_w);
               m_tab8_montar_stoch_slow_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_stoch_slow_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_stoch_slow_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_stoch_slow_spin[i].CreateTextEdit("",montar_stoch_x,montar_stoch_y+104))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_stoch_slow_spin[i]);
               m_tab8_montar_stoch_slow_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_stoch_slow_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_stoch_slow_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_stoch_slow_spin[i].BorderColor(tab2_border);
               m_tab8_montar_stoch_slow_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_stoch_slow_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_stoch_slow_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_stoch_slow_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_stoch_slow_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_stoch_slow_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_stoch_slow_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_stoch_slow_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_stoch_ma_type_label[i],"Tipo de média",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_stoch_x,montar_stoch_y+132,montar_stoch_w,16))
                  return(false);
               m_tab8_montar_stoch_ma_type_label[i].FontSize(9);
               m_tab8_montar_stoch_ma_type_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_stoch_ma_type_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_stoch_ma_type_combo[i]);
               m_tab8_montar_stoch_ma_type_combo[i].XSize(montar_stoch_w);
               m_tab8_montar_stoch_ma_type_combo[i].YSize(montar_stoch_h);
               m_tab8_montar_stoch_ma_type_combo[i].BackColor(clrWhite);
               m_tab8_montar_stoch_ma_type_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_stoch_ma_type_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_stoch_ma_type_combo[i].BorderColor(tab2_border);
               m_tab8_montar_stoch_ma_type_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_stoch_ma_type_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_stoch_ma_type_combo[i].FontSize(10);
               m_tab8_montar_stoch_ma_type_combo[i].ItemsTotal(ArraySize(montar_ma_type_items));
               m_tab8_montar_stoch_ma_type_combo[i].CheckBoxMode(false);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().XSize(montar_stoch_w-2);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().YSize(montar_stoch_h);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().IconXGap((montar_stoch_w-2)-18);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_stoch_ma_type_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_ma_type_items);m++) m_tab8_montar_stoch_ma_type_combo[i].SetValue(m,montar_ma_type_items[m]);
               m_tab8_montar_stoch_ma_type_combo[i].GetListViewPointer().YSize(140);
               m_tab8_montar_stoch_ma_type_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_stoch_ma_type_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_stoch_ma_type_combo[i].CreateComboBox("",montar_stoch_x,montar_stoch_y+148))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_stoch_ma_type_combo[i]);
               m_tab8_montar_stoch_ma_type_combo[i].SelectItem(0);

               if(!CreateTextLabel(m_tab8_montar_stoch_price_type_label[i],"Tipo de estocástico",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_stoch_x,montar_stoch_y+176,montar_stoch_w,16))
                  return(false);
               m_tab8_montar_stoch_price_type_label[i].FontSize(9);
               m_tab8_montar_stoch_price_type_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_stoch_price_type_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_stoch_price_type_combo[i]);
               m_tab8_montar_stoch_price_type_combo[i].XSize(montar_stoch_w);
               m_tab8_montar_stoch_price_type_combo[i].YSize(montar_stoch_h);
               m_tab8_montar_stoch_price_type_combo[i].BackColor(clrWhite);
               m_tab8_montar_stoch_price_type_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_stoch_price_type_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_stoch_price_type_combo[i].BorderColor(tab2_border);
               m_tab8_montar_stoch_price_type_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_stoch_price_type_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_stoch_price_type_combo[i].FontSize(10);
               m_tab8_montar_stoch_price_type_combo[i].ItemsTotal(ArraySize(montar_stoch_type_items));
               m_tab8_montar_stoch_price_type_combo[i].CheckBoxMode(false);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().XSize(montar_stoch_w-2);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().YSize(montar_stoch_h);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().IconXGap((montar_stoch_w-2)-18);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_stoch_price_type_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int t=0;t<ArraySize(montar_stoch_type_items);t++) m_tab8_montar_stoch_price_type_combo[i].SetValue(t,montar_stoch_type_items[t]);
               m_tab8_montar_stoch_price_type_combo[i].GetListViewPointer().YSize(120);
               m_tab8_montar_stoch_price_type_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_stoch_price_type_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_stoch_price_type_combo[i].CreateComboBox("",montar_stoch_x,montar_stoch_y+192))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_stoch_price_type_combo[i]);
               m_tab8_montar_stoch_price_type_combo[i].SelectItem(0);
              }
            else if(p==11)
              {
               const int montar_rsi_x=12;
               const int montar_rsi_title_y=8;
               const int montar_rsi_y=28;
               const int montar_rsi_w=montar_param_card_w-48;
               const int montar_rsi_h=20;
               const int montar_rsi_spin_edit_w=montar_rsi_w-34;
               const string montar_rsi_title=(string)(i+1)+" rsi";

               if(!CreateTextLabel(m_tab8_montar_rsi_title[i],montar_rsi_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_rsi_x,montar_rsi_title_y,montar_rsi_w,16))
                  return(false);
               m_tab8_montar_rsi_title[i].FontSize(9);
               m_tab8_montar_rsi_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_rsi_period_label[i],"Período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_rsi_x,montar_rsi_y,montar_rsi_w,16))
                  return(false);
               m_tab8_montar_rsi_period_label[i].FontSize(9);
               m_tab8_montar_rsi_period_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_rsi_period_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_rsi_period_spin[i]);
               m_tab8_montar_rsi_period_spin[i].XSize(montar_rsi_w);
               m_tab8_montar_rsi_period_spin[i].MaxValue(9999.0);
               m_tab8_montar_rsi_period_spin[i].MinValue(0.0);
               m_tab8_montar_rsi_period_spin[i].StepValue(1.0);
               m_tab8_montar_rsi_period_spin[i].SetDigits(0);
               m_tab8_montar_rsi_period_spin[i].SpinEditMode(true);
               m_tab8_montar_rsi_period_spin[i].CheckBoxMode(false);
               m_tab8_montar_rsi_period_spin[i].SetValue("5");
               m_tab8_montar_rsi_period_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_rsi_period_spin[i].GetTextBoxPointer().XSize(montar_rsi_spin_edit_w);
               m_tab8_montar_rsi_period_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_rsi_period_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_rsi_period_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_rsi_period_spin[i].CreateTextEdit("",montar_rsi_x,montar_rsi_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_rsi_period_spin[i]);
               m_tab8_montar_rsi_period_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_rsi_period_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_rsi_period_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_rsi_period_spin[i].BorderColor(tab2_border);
               m_tab8_montar_rsi_period_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_rsi_period_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_rsi_period_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_rsi_period_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_rsi_period_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_rsi_period_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_rsi_period_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_rsi_period_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_rsi_price_label[i],"Modo de preço",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_rsi_x,montar_rsi_y+44,montar_rsi_w,16))
                  return(false);
               m_tab8_montar_rsi_price_label[i].FontSize(9);
               m_tab8_montar_rsi_price_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_rsi_price_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_rsi_price_combo[i]);
               m_tab8_montar_rsi_price_combo[i].XSize(montar_rsi_w);
               m_tab8_montar_rsi_price_combo[i].YSize(montar_rsi_h);
               m_tab8_montar_rsi_price_combo[i].BackColor(clrWhite);
               m_tab8_montar_rsi_price_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_rsi_price_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_rsi_price_combo[i].BorderColor(tab2_border);
               m_tab8_montar_rsi_price_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_rsi_price_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_rsi_price_combo[i].FontSize(10);
               m_tab8_montar_rsi_price_combo[i].ItemsTotal(ArraySize(montar_price_items));
               m_tab8_montar_rsi_price_combo[i].CheckBoxMode(false);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().XSize(montar_rsi_w-2);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().YSize(montar_rsi_h);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().IconXGap((montar_rsi_w-2)-18);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_rsi_price_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_price_items);m++) m_tab8_montar_rsi_price_combo[i].SetValue(m,montar_price_items[m]);
               m_tab8_montar_rsi_price_combo[i].GetListViewPointer().YSize(160);
               m_tab8_montar_rsi_price_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_rsi_price_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_rsi_price_combo[i].CreateComboBox("",montar_rsi_x,montar_rsi_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_rsi_price_combo[i]);
               m_tab8_montar_rsi_price_combo[i].SelectItem(0);
              }
            else if(p==12)
              {
               const int montar_std_x=12;
               const int montar_std_title_y=8;
               const int montar_std_y=28;
               const int montar_std_w=montar_param_card_w-48;
               const int montar_std_h=20;
               const int montar_std_spin_edit_w=montar_std_w-34;
               const string montar_std_title=(string)(i+1)+" desvio padrao";

               if(!CreateTextLabel(m_tab8_montar_stddev_title[i],montar_std_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_std_x,montar_std_title_y,montar_std_w,16))
                  return(false);
               m_tab8_montar_stddev_title[i].FontSize(9);
               m_tab8_montar_stddev_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_stddev_period_label[i],"Período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_std_x,montar_std_y,montar_std_w,16))
                  return(false);
               m_tab8_montar_stddev_period_label[i].FontSize(9);
               m_tab8_montar_stddev_period_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_stddev_period_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_stddev_period_spin[i]);
               m_tab8_montar_stddev_period_spin[i].XSize(montar_std_w);
               m_tab8_montar_stddev_period_spin[i].MaxValue(9999.0);
               m_tab8_montar_stddev_period_spin[i].MinValue(0.0);
               m_tab8_montar_stddev_period_spin[i].StepValue(1.0);
               m_tab8_montar_stddev_period_spin[i].SetDigits(0);
               m_tab8_montar_stddev_period_spin[i].SpinEditMode(true);
               m_tab8_montar_stddev_period_spin[i].CheckBoxMode(false);
               m_tab8_montar_stddev_period_spin[i].SetValue("5");
               m_tab8_montar_stddev_period_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_stddev_period_spin[i].GetTextBoxPointer().XSize(montar_std_spin_edit_w);
               m_tab8_montar_stddev_period_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_stddev_period_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_stddev_period_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_stddev_period_spin[i].CreateTextEdit("",montar_std_x,montar_std_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_stddev_period_spin[i]);
               m_tab8_montar_stddev_period_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_stddev_period_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_stddev_period_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_stddev_period_spin[i].BorderColor(tab2_border);
               m_tab8_montar_stddev_period_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_stddev_period_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_stddev_period_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_stddev_period_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_stddev_period_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_stddev_period_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_stddev_period_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_stddev_period_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_stddev_shift_label[i],"Deslocamento",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_std_x,montar_std_y+44,montar_std_w,16))
                  return(false);
               m_tab8_montar_stddev_shift_label[i].FontSize(9);
               m_tab8_montar_stddev_shift_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_stddev_shift_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_stddev_shift_spin[i]);
               m_tab8_montar_stddev_shift_spin[i].XSize(montar_std_w);
               m_tab8_montar_stddev_shift_spin[i].MaxValue(9999.0);
               m_tab8_montar_stddev_shift_spin[i].MinValue(0.0);
               m_tab8_montar_stddev_shift_spin[i].StepValue(1.0);
               m_tab8_montar_stddev_shift_spin[i].SetDigits(0);
               m_tab8_montar_stddev_shift_spin[i].SpinEditMode(true);
               m_tab8_montar_stddev_shift_spin[i].CheckBoxMode(false);
               m_tab8_montar_stddev_shift_spin[i].SetValue("0");
               m_tab8_montar_stddev_shift_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_stddev_shift_spin[i].GetTextBoxPointer().XSize(montar_std_spin_edit_w);
               m_tab8_montar_stddev_shift_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_stddev_shift_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_stddev_shift_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_stddev_shift_spin[i].CreateTextEdit("",montar_std_x,montar_std_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_stddev_shift_spin[i]);
               m_tab8_montar_stddev_shift_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_stddev_shift_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_stddev_shift_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_stddev_shift_spin[i].BorderColor(tab2_border);
               m_tab8_montar_stddev_shift_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_stddev_shift_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_stddev_shift_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_stddev_shift_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_stddev_shift_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_stddev_shift_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_stddev_shift_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_stddev_shift_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_stddev_ma_type_label[i],"Tipo de média",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_std_x,montar_std_y+88,montar_std_w,16))
                  return(false);
               m_tab8_montar_stddev_ma_type_label[i].FontSize(9);
               m_tab8_montar_stddev_ma_type_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_stddev_ma_type_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_stddev_ma_type_combo[i]);
               m_tab8_montar_stddev_ma_type_combo[i].XSize(montar_std_w);
               m_tab8_montar_stddev_ma_type_combo[i].YSize(montar_std_h);
               m_tab8_montar_stddev_ma_type_combo[i].BackColor(clrWhite);
               m_tab8_montar_stddev_ma_type_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_stddev_ma_type_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_stddev_ma_type_combo[i].BorderColor(tab2_border);
               m_tab8_montar_stddev_ma_type_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_stddev_ma_type_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_stddev_ma_type_combo[i].FontSize(10);
               m_tab8_montar_stddev_ma_type_combo[i].ItemsTotal(ArraySize(montar_ma_type_items));
               m_tab8_montar_stddev_ma_type_combo[i].CheckBoxMode(false);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().XSize(montar_std_w-2);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().YSize(montar_std_h);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().IconXGap((montar_std_w-2)-18);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_stddev_ma_type_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_ma_type_items);m++) m_tab8_montar_stddev_ma_type_combo[i].SetValue(m,montar_ma_type_items[m]);
               m_tab8_montar_stddev_ma_type_combo[i].GetListViewPointer().YSize(140);
               m_tab8_montar_stddev_ma_type_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_stddev_ma_type_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_stddev_ma_type_combo[i].CreateComboBox("",montar_std_x,montar_std_y+104))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_stddev_ma_type_combo[i]);
               m_tab8_montar_stddev_ma_type_combo[i].SelectItem(0);

               if(!CreateTextLabel(m_tab8_montar_stddev_price_label[i],"Modo de preço",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_std_x,montar_std_y+132,montar_std_w,16))
                  return(false);
               m_tab8_montar_stddev_price_label[i].FontSize(9);
               m_tab8_montar_stddev_price_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_stddev_price_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_stddev_price_combo[i]);
               m_tab8_montar_stddev_price_combo[i].XSize(montar_std_w);
               m_tab8_montar_stddev_price_combo[i].YSize(montar_std_h);
               m_tab8_montar_stddev_price_combo[i].BackColor(clrWhite);
               m_tab8_montar_stddev_price_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_stddev_price_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_stddev_price_combo[i].BorderColor(tab2_border);
               m_tab8_montar_stddev_price_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_stddev_price_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_stddev_price_combo[i].FontSize(10);
               m_tab8_montar_stddev_price_combo[i].ItemsTotal(ArraySize(montar_price_items));
               m_tab8_montar_stddev_price_combo[i].CheckBoxMode(false);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().XSize(montar_std_w-2);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().YSize(montar_std_h);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().IconXGap((montar_std_w-2)-18);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_stddev_price_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int m=0;m<ArraySize(montar_price_items);m++) m_tab8_montar_stddev_price_combo[i].SetValue(m,montar_price_items[m]);
               m_tab8_montar_stddev_price_combo[i].GetListViewPointer().YSize(160);
               m_tab8_montar_stddev_price_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_stddev_price_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_stddev_price_combo[i].CreateComboBox("",montar_std_x,montar_std_y+148))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_stddev_price_combo[i]);
               m_tab8_montar_stddev_price_combo[i].SelectItem(0);
              }
            else if(p==13)
              {
               const int montar_vol_x=12;
               const int montar_vol_title_y=8;
               const int montar_vol_y=28;
               const int montar_vol_w=montar_param_card_w-48;
               const int montar_vol_h=20;
               const string montar_vol_title=(string)(i+1)+" volume";
               string montar_volume_items[];
               ArrayResize(montar_volume_items,2);
               montar_volume_items[0]="Volume de Tick";
               montar_volume_items[1]="Volume Real";

               if(!CreateTextLabel(m_tab8_montar_volume_title[i],montar_vol_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_vol_x,montar_vol_title_y,montar_vol_w,16))
                  return(false);
               m_tab8_montar_volume_title[i].FontSize(9);
               m_tab8_montar_volume_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_volume_type_label[i],"Volume",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_vol_x,montar_vol_y,montar_vol_w,16))
                  return(false);
               m_tab8_montar_volume_type_label[i].FontSize(9);
               m_tab8_montar_volume_type_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_volume_type_combo[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_volume_type_combo[i]);
               m_tab8_montar_volume_type_combo[i].XSize(montar_vol_w);
               m_tab8_montar_volume_type_combo[i].YSize(montar_vol_h);
               m_tab8_montar_volume_type_combo[i].BackColor(clrWhite);
               m_tab8_montar_volume_type_combo[i].BackColorHover(clrWhite);
               m_tab8_montar_volume_type_combo[i].BackColorPressed(clrWhite);
               m_tab8_montar_volume_type_combo[i].BorderColor(tab2_border);
               m_tab8_montar_volume_type_combo[i].BorderColorHover(tab2_border);
               m_tab8_montar_volume_type_combo[i].BorderColorPressed(tab2_border);
               m_tab8_montar_volume_type_combo[i].FontSize(10);
               m_tab8_montar_volume_type_combo[i].ItemsTotal(ArraySize(montar_volume_items));
               m_tab8_montar_volume_type_combo[i].CheckBoxMode(false);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().XGap(1);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().XSize(montar_vol_w-2);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().YSize(montar_vol_h);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().BackColor(clrWhite);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().BackColorHover(clrWhite);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().BorderColor(tab2_border);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().IconXGap((montar_vol_w-2)-18);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().LabelXGap(10);
               m_tab8_montar_volume_type_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
               for(int v=0;v<ArraySize(montar_volume_items);v++) m_tab8_montar_volume_type_combo[i].SetValue(v,montar_volume_items[v]);
               m_tab8_montar_volume_type_combo[i].GetListViewPointer().YSize(120);
               m_tab8_montar_volume_type_combo[i].GetListViewPointer().LightsHover(true);
               m_tab8_montar_volume_type_combo[i].GetListViewPointer().BackColor(clrWhite);
               if(!m_tab8_montar_volume_type_combo[i].CreateComboBox("",montar_vol_x,montar_vol_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_volume_type_combo[i]);
               m_tab8_montar_volume_type_combo[i].SelectItem(0);
              }
            else if(p==14)
              {
               const int montar_atr_x=12;
               ...
               const int montar_atr_y=28;
               const int montar_atr_w=montar_param_card_w-48;
               const int montar_atr_spin_edit_w=montar_atr_w-22;
               const string montar_atr_title=(string)(i+1)+" atr";

               if(!CreateTextLabel(m_tab8_montar_atr_simple_title[i],montar_atr_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_atr_x,montar_atr_title_y,montar_atr_w,16))
                  return(false);
               m_tab8_montar_atr_simple_title[i].FontSize(9);
               m_tab8_montar_atr_simple_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_atr_simple_period_label[i],"Período",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_atr_x,montar_atr_y,montar_atr_w,16))
                  return(false);
               m_tab8_montar_atr_simple_period_label[i].FontSize(9);
               m_tab8_montar_atr_simple_period_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_atr_simple_period_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_atr_simple_period_spin[i]);
               m_tab8_montar_atr_simple_period_spin[i].XSize(montar_atr_w);
               m_tab8_montar_atr_simple_period_spin[i].MaxValue(9999.0);
               m_tab8_montar_atr_simple_period_spin[i].MinValue(0.0);
               m_tab8_montar_atr_simple_period_spin[i].StepValue(1.0);
               m_tab8_montar_atr_simple_period_spin[i].SetDigits(0);
               m_tab8_montar_atr_simple_period_spin[i].SpinEditMode(true);
               m_tab8_montar_atr_simple_period_spin[i].CheckBoxMode(false);
               m_tab8_montar_atr_simple_period_spin[i].SetValue("0");
               m_tab8_montar_atr_simple_period_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_atr_simple_period_spin[i].GetTextBoxPointer().XSize(montar_atr_spin_edit_w);
               m_tab8_montar_atr_simple_period_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_atr_simple_period_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_atr_simple_period_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_atr_simple_period_spin[i].CreateTextEdit("",montar_atr_x,montar_atr_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_atr_simple_period_spin[i]);
               m_tab8_montar_atr_simple_period_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_atr_simple_period_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_atr_simple_period_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_atr_simple_period_spin[i].BorderColor(tab2_border);
               m_tab8_montar_atr_simple_period_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_atr_simple_period_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_atr_simple_period_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_atr_simple_period_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_atr_simple_period_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_atr_simple_period_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_atr_simple_period_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_atr_simple_period_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);
              }
            else if(p==15)
              {
               const int montar_sar_x=12;
               const int montar_sar_title_y=8;
               const int montar_sar_y=28;
               const int montar_sar_w=montar_param_card_w-48;
               const int montar_sar_spin_edit_w=montar_sar_w-22;
               const string montar_sar_title=(string)(i+1)+" parabolic sar";

               if(!CreateTextLabel(m_tab8_montar_sar_title[i],montar_sar_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_sar_x,montar_sar_title_y,montar_sar_w,16))
                  return(false);
               m_tab8_montar_sar_title[i].FontSize(9);
               m_tab8_montar_sar_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_sar_step_label[i],"Passo",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_sar_x,montar_sar_y,montar_sar_w,16))
                  return(false);
               m_tab8_montar_sar_step_label[i].FontSize(9);
               m_tab8_montar_sar_step_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_sar_step_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_sar_step_spin[i]);
               m_tab8_montar_sar_step_spin[i].XSize(montar_sar_w);
               m_tab8_montar_sar_step_spin[i].MaxValue(9999.0);
               m_tab8_montar_sar_step_spin[i].MinValue(0.0);
               m_tab8_montar_sar_step_spin[i].StepValue(0.1);
               m_tab8_montar_sar_step_spin[i].SetDigits(1);
               m_tab8_montar_sar_step_spin[i].SpinEditMode(true);
               m_tab8_montar_sar_step_spin[i].CheckBoxMode(false);
               m_tab8_montar_sar_step_spin[i].SetValue("1");
               m_tab8_montar_sar_step_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_sar_step_spin[i].GetTextBoxPointer().XSize(montar_sar_spin_edit_w);
               m_tab8_montar_sar_step_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_sar_step_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_sar_step_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_sar_step_spin[i].CreateTextEdit("",montar_sar_x,montar_sar_y+16))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_sar_step_spin[i]);
               m_tab8_montar_sar_step_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_sar_step_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_sar_step_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_sar_step_spin[i].BorderColor(tab2_border);
               m_tab8_montar_sar_step_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_sar_step_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_sar_step_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_sar_step_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_sar_step_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_sar_step_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_sar_step_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_sar_step_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);

               if(!CreateTextLabel(m_tab8_montar_sar_max_label[i],"Máximo",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_sar_x,montar_sar_y+44,montar_sar_w,16))
                  return(false);
               m_tab8_montar_sar_max_label[i].FontSize(9);
               m_tab8_montar_sar_max_label[i].LabelColor(C'91,78,64');

               m_tab8_montar_sar_max_spin[i].MainPointer(m_tab8_montar_param_card_tabs[i]);
               m_tab8_montar_param_card_tabs[i].AddToElementsArray(p,m_tab8_montar_sar_max_spin[i]);
               m_tab8_montar_sar_max_spin[i].XSize(montar_sar_w);
               m_tab8_montar_sar_max_spin[i].MaxValue(9999.0);
               m_tab8_montar_sar_max_spin[i].MinValue(0.0);
               m_tab8_montar_sar_max_spin[i].StepValue(0.1);
               m_tab8_montar_sar_max_spin[i].SetDigits(1);
               m_tab8_montar_sar_max_spin[i].SpinEditMode(true);
               m_tab8_montar_sar_max_spin[i].CheckBoxMode(false);
               m_tab8_montar_sar_max_spin[i].SetValue("0.2");
               m_tab8_montar_sar_max_spin[i].AnchorBottomWindowSide(false);
               m_tab8_montar_sar_max_spin[i].GetTextBoxPointer().XSize(montar_sar_spin_edit_w);
               m_tab8_montar_sar_max_spin[i].GetTextBoxPointer().AutoSelectionMode(true);
               m_tab8_montar_sar_max_spin[i].GetTextBoxPointer().AnchorRightWindowSide(false);
               m_tab8_montar_sar_max_spin[i].GetTextBoxPointer().XGap(1);
               if(!m_tab8_montar_sar_max_spin[i].CreateTextEdit("",montar_sar_x,montar_sar_y+60))
                  return(false);
               AddToElementsArray(m_window_index,m_tab8_montar_sar_max_spin[i]);
               m_tab8_montar_sar_max_spin[i].BackColor(C'239,231,218');
               m_tab8_montar_sar_max_spin[i].BackColorHover(C'239,231,218');
               m_tab8_montar_sar_max_spin[i].BackColorPressed(C'239,231,218');
               m_tab8_montar_sar_max_spin[i].BorderColor(tab2_border);
               m_tab8_montar_sar_max_spin[i].BorderColorHover(tab2_border);
               m_tab8_montar_sar_max_spin[i].BorderColorPressed(tab2_border);
               m_tab8_montar_sar_max_spin[i].GetTextBoxPointer().BackColor(clrWhite);
               m_tab8_montar_sar_max_spin[i].GetTextBoxPointer().BackColorHover(clrWhite);
               m_tab8_montar_sar_max_spin[i].GetTextBoxPointer().BackColorPressed(clrWhite);
               m_tab8_montar_sar_max_spin[i].GetTextBoxPointer().BorderColor(tab2_border);
               m_tab8_montar_sar_max_spin[i].GetTextBoxPointer().BorderColorHover(tab2_border);
               m_tab8_montar_sar_max_spin[i].GetTextBoxPointer().BorderColorPressed(tab2_border);
              }
            else if(p==16)
              {
               const int montar_fractal_x=12;
               const int montar_fractal_title_y=8;
               const int montar_fractal_y=28;
               const int montar_fractal_w=montar_param_card_w-48;
               const string montar_fractal_title=(string)(i+1)+" fractal";

               if(!CreateTextLabel(m_tab8_montar_fractal_title[i],montar_fractal_title,m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_fractal_x,montar_fractal_title_y,montar_fractal_w,16))
                  return(false);
               m_tab8_montar_fractal_title[i].FontSize(9);
               m_tab8_montar_fractal_title[i].LabelColor(C'91,78,64');

               if(!CreateTextLabel(m_tab8_montar_fractal_empty_label[i],"Sem Parametros",m_tab8_montar_param_card_tabs[i],m_window_index,m_tab8_montar_param_card_tabs[i],p,montar_fractal_x,montar_fractal_y,montar_fractal_w,16))
                  return(false);
      ...
      if(!CreateFrame(m_tab8_montar_sinais_card,"",m_tab8_montar_tabs,m_window_index,m_tab8_montar_tabs,1,montar_sinais_card_x,montar_sinais_card_y,montar_sinais_card_w,montar_sinais_card_h,1))
         return(false);
      m_tab8_montar_sinais_card.BackColor(C'233,220,203');
      m_tab8_montar_sinais_card.BorderColor(C'197,168,136');

      if(!CreateTextLabel(m_tab8_montar_sinais_card_title,"Conectores lógicos",m_tab8_montar_sinais_card,m_window_index,m_tab8_montar_tabs,1,16,12,montar_sinais_card_w-32,22))
         return(false);
      ...
      montar_sinais_logic_items[1]="E";
      montar_sinais_logic_items[2]="OU";
      montar_sinais_logic_items[3]="E SE";
      montar_sinais_logic_items[4]="OU SE";
      montar_sinais_logic_items[5]="E Também";
      montar_sinais_logic_items[6]="OU Também";

      string montar_sinais_candle_items[];
      ArrayResize(montar_sinais_candle_items,4);
      montar_sinais_candle_items[0]="Vela atual";
      montar_sinais_candle_items[1]="Vela anterior";
      montar_sinais_candle_items[2]="Penúltima vela";
      montar_sinais_candle_items[3]="Anti Penúltima";

      string montar_sinais_compare_items[];
      ArrayResize(montar_sinais_compare_items,10);
      montar_sinais_compare_items[0]="Maior que";
      montar_sinais_compare_items[1]="Menor que";
      montar_sinais_compare_items[2]="Maior ou igual que";
      montar_sinais_compare_items[3]="Menor ou igual que";
      montar_sinais_compare_items[4]="Igual que";
      montar_sinais_compare_items[5]="Diferente de";
      montar_sinais_compare_items[6]="Cruzar p/ cima de";
      montar_sinais_compare_items[7]="Cruzar p/ baixo de";
      montar_sinais_compare_items[8]="Cruzar&fechar acima de";
      montar_sinais_compare_items[9]="Cruzar&fechar abaixo de";

      const int montar_sinais_inner_x=16;
      const int montar_sinais_col_gap=6;
      const int montar_sinais_logic_w=84;
      const int montar_sinais_candle_w=92;
      const int montar_sinais_compare_w=126;
      const int montar_sinais_value_w=(montar_sinais_card_w-32-montar_sinais_logic_w-(2*montar_sinais_candle_w)-montar_sinais_compare_w-(5*montar_sinais_col_gap))/2;
      const int montar_sinais_value_x=montar_sinais_inner_x+montar_sinais_logic_w+montar_sinais_col_gap;
      const int montar_sinais_candle_x=montar_sinais_value_x+montar_sinais_value_w+montar_sinais_col_gap;
      const int montar_sinais_compare_x=montar_sinais_candle_x+montar_sinais_candle_w+montar_sinais_col_gap;
      const int montar_sinais_compare_value_x=montar_sinais_compare_x+montar_sinais_compare_w+montar_sinais_col_gap;
      const int montar_sinais_compare_candle_x=montar_sinais_compare_value_x+montar_sinais_value_w+montar_sinais_col_gap;
      const int montar_sinais_combo_h=20;
      const int montar_sinais_col_title_y=40;
      const int montar_sinais_col_title_h=16;
      int montar_sinais_row_y=62;

      if(!CreateTextLabel(m_tab8_montar_sinais_logic_title,"Operador",m_tab8_montar_sinais_card,m_window_index,m_tab8_montar_tabs,1,montar_sinais_inner_x,montar_sinais_col_title_y,montar_sinais_logic_w,montar_sinais_col_title_h))
         return(false);
      m_tab8_montar_sinais_logic_title.FontSize(9);
      m_tab8_montar_sinais_logic_title.LabelColor(C'91,78,64');

      if(!CreateTextLabel(m_tab8_montar_sinais_value_title,"Valor ref.",m_tab8_montar_sinais_card,m_window_index,m_tab8_montar_tabs,1,montar_sinais_value_x,montar_sinais_col_title_y,montar_sinais_value_w,montar_sinais_col_title_h))
         return(false);
      m_tab8_montar_sinais_value_title.FontSize(9);
      m_tab8_montar_sinais_value_title.LabelColor(C'91,78,64');

      if(!CreateTextLabel(m_tab8_montar_sinais_candle_title,"Velas",m_tab8_montar_sinais_card,m_window_index,m_tab8_montar_tabs,1,montar_sinais_candle_x,montar_sinais_col_title_y,montar_sinais_candle_w,montar_sinais_col_title_h))
         return(false);
      m_tab8_montar_sinais_candle_title.FontSize(9);
      m_tab8_montar_sinais_candle_title.LabelColor(C'91,78,64');

      if(!CreateTextLabel(m_tab8_montar_sinais_compare_title,"Comparação",m_tab8_montar_sinais_card,m_window_index,m_tab8_montar_tabs,1,montar_sinais_compare_x,montar_sinais_col_title_y,montar_sinais_compare_w,montar_sinais_col_title_h))
         return(false);
      m_tab8_montar_sinais_compare_title.FontSize(9);
      m_tab8_montar_sinais_compare_title.LabelColor(C'91,78,64');

      if(!CreateTextLabel(m_tab8_montar_sinais_compare_value_title,"Valor ref.",m_tab8_montar_sinais_card,m_window_index,m_tab8_montar_tabs,1,montar_sinais_compare_value_x,montar_sinais_col_title_y,montar_sinais_value_w,montar_sinais_col_title_h))
         return(false);
      m_tab8_montar_sinais_compare_value_title.FontSize(9);
      m_tab8_montar_sinais_compare_value_title.LabelColor(C'91,78,64');

      if(!CreateTextLabel(m_tab8_montar_sinais_compare_candle_title,"Velas",m_tab8_montar_sinais_card,m_window_index,m_tab8_montar_tabs,1,montar_sinais_compare_candle_x,montar_sinais_col_title_y,montar_sinais_candle_w,montar_sinais_col_title_h))
         return(false);
      m_tab8_montar_sinais_compare_candle_title.FontSize(9);
      m_tab8_montar_sinais_compare_candle_title.LabelColor(C'91,78,64');

      for(int i=0;i<5;i++)
        {
         m_tab8_montar_sinais_logic_combo[i].MainPointer(m_tab8_montar_sinais_card);
         m_tab8_montar_tabs.AddToElementsArray(1,m_tab8_montar_sinais_logic_combo[i]);
         m_tab8_montar_sinais_logic_combo[i].XSize(montar_sinais_logic_w);
         m_tab8_montar_sinais_logic_combo[i].YSize(montar_sinais_combo_h);
         m_tab8_montar_sinais_logic_combo[i].BackColor(clrWhite);
         m_tab8_montar_sinais_logic_combo[i].BackColorHover(clrWhite);
         m_tab8_montar_sinais_logic_combo[i].BackColorPressed(clrWhite);
         m_tab8_montar_sinais_logic_combo[i].BorderColor(tab2_border);
         m_tab8_montar_sinais_logic_combo[i].BorderColorHover(tab2_border);
         m_tab8_montar_sinais_logic_combo[i].BorderColorPressed(tab2_border);
         m_tab8_montar_sinais_logic_combo[i].FontSize(10);
         m_tab8_montar_sinais_logic_combo[i].ItemsTotal(ArraySize(montar_sinais_logic_items));
         m_tab8_montar_sinais_logic_combo[i].CheckBoxMode(false);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().XGap(1);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().XSize(montar_sinais_logic_w-2);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().YSize(montar_sinais_combo_h);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().BackColor(clrWhite);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().BackColorHover(clrWhite);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().BorderColor(tab2_border);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().IconXGap((montar_sinais_logic_w-2)-18);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().LabelXGap(10);
         m_tab8_montar_sinais_logic_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
         for(int p=0;p<ArraySize(montar_sinais_logic_items);p++) m_tab8_montar_sinais_logic_combo[i].SetValue(p,montar_sinais_logic_items[p]);
         m_tab8_montar_sinais_logic_combo[i].GetListViewPointer().YSize(120);
         m_tab8_montar_sinais_logic_combo[i].GetListViewPointer().LightsHover(true);
         m_tab8_montar_sinais_logic_combo[i].GetListViewPointer().BackColor(clrWhite);
         if(!m_tab8_montar_sinais_logic_combo[i].CreateComboBox("",montar_sinais_inner_x,montar_sinais_row_y))
            return(false);
         AddToElementsArray(m_window_index,m_tab8_montar_sinais_logic_combo[i]);
         m_tab8_montar_sinais_logic_combo[i].SelectItem(0);

         m_tab8_montar_sinais_candle_combo[i].MainPointer(m_tab8_montar_sinais_card);
         m_tab8_montar_tabs.AddToElementsArray(1,m_tab8_montar_sinais_candle_combo[i]);
         m_tab8_montar_sinais_candle_combo[i].XSize(montar_sinais_candle_w);
         m_tab8_montar_sinais_candle_combo[i].YSize(montar_sinais_combo_h);
         m_tab8_montar_sinais_candle_combo[i].BackColor(clrWhite);
         m_tab8_montar_sinais_candle_combo[i].BackColorHover(clrWhite);
         m_tab8_montar_sinais_candle_combo[i].BackColorPressed(clrWhite);
         m_tab8_montar_sinais_candle_combo[i].BorderColor(tab2_border);
         m_tab8_montar_sinais_candle_combo[i].BorderColorHover(tab2_border);
         m_tab8_montar_sinais_candle_combo[i].BorderColorPressed(tab2_border);
         m_tab8_montar_sinais_candle_combo[i].FontSize(10);
         m_tab8_montar_sinais_candle_combo[i].ItemsTotal(ArraySize(montar_sinais_candle_items));
         m_tab8_montar_sinais_candle_combo[i].CheckBoxMode(false);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().XGap(1);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().XSize(montar_sinais_candle_w-2);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().YSize(montar_sinais_combo_h);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().BackColor(clrWhite);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().BackColorHover(clrWhite);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().BorderColor(tab2_border);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().IconXGap((montar_sinais_candle_w-2)-18);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().LabelXGap(10);
         m_tab8_montar_sinais_candle_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
         for(int p=0;p<ArraySize(montar_sinais_candle_items);p++) m_tab8_montar_sinais_candle_combo[i].SetValue(p,montar_sinais_candle_items[p]);
         m_tab8_montar_sinais_candle_combo[i].GetListViewPointer().YSize(120);
         m_tab8_montar_sinais_candle_combo[i].GetListViewPointer().LightsHover(true);
         m_tab8_montar_sinais_candle_combo[i].GetListViewPointer().BackColor(clrWhite);
         if(!m_tab8_montar_sinais_candle_combo[i].CreateComboBox("",montar_sinais_candle_x,montar_sinais_row_y))
            return(false);
         AddToElementsArray(m_window_index,m_tab8_montar_sinais_candle_combo[i]);
         m_tab8_montar_sinais_candle_combo[i].SelectItem(0);

         m_tab8_montar_sinais_value_combo[i].MainPointer(m_tab8_montar_sinais_card);
         m_tab8_montar_tabs.AddToElementsArray(1,m_tab8_montar_sinais_value_combo[i]);
         m_tab8_montar_sinais_value_combo[i].XSize(montar_sinais_value_w);
         m_tab8_montar_sinais_value_combo[i].YSize(montar_sinais_combo_h);
         m_tab8_montar_sinais_value_combo[i].BackColor(clrWhite);
         m_tab8_montar_sinais_value_combo[i].BackColorHover(clrWhite);
         m_tab8_montar_sinais_value_combo[i].BackColorPressed(clrWhite);
         m_tab8_montar_sinais_value_combo[i].BorderColor(tab2_border);
         ...
         m_tab8_montar_sinais_value_combo[i].GetButtonPointer().XSize(montar_sinais_value_w-2);
         m_tab8_montar_sinais_value_combo[i].GetButtonPointer().YSize(montar_sinais_combo_h);
         m_tab8_montar_sinais_value_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
         m_tab8_montar_sinais_value_combo[i].GetButtonPointer().BackColor(clrWhite);
         m_tab8_montar_sinais_value_combo[i].GetButtonPointer().BackColorHover(clrWhite);
         m_tab8_montar_sinais_value_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
         m_tab8_montar_sinais_value_combo[i].GetButtonPointer().BorderColor(tab2_border);
         m_tab8_montar_sinais_value_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
         m_tab8_montar_sinais_value_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
         m_tab8_montar_sinais_value_combo[i].GetButtonPointer().IconXGap((montar_sinais_value_w-2)-18);
         ...
         m_tab8_montar_sinais_compare_combo[i].MainPointer(m_tab8_montar_sinais_card);
         m_tab8_montar_tabs.AddToElementsArray(1,m_tab8_montar_sinais_compare_combo[i]);
         m_tab8_montar_sinais_compare_combo[i].XSize(montar_sinais_compare_w);
         m_tab8_montar_sinais_compare_combo[i].YSize(montar_sinais_combo_h);
         m_tab8_montar_sinais_compare_combo[i].BackColor(clrWhite);
         m_tab8_montar_sinais_compare_combo[i].BackColorHover(clrWhite);
         m_tab8_montar_sinais_compare_combo[i].BackColorPressed(clrWhite);
         m_tab8_montar_sinais_compare_combo[i].BorderColor(tab2_border);
         m_tab8_montar_sinais_compare_combo[i].BorderColorHover(tab2_border);
         m_tab8_montar_sinais_compare_combo[i].BorderColorPressed(tab2_border);
         m_tab8_montar_sinais_compare_combo[i].FontSize(10);
         m_tab8_montar_sinais_compare_combo[i].ItemsTotal(ArraySize(montar_sinais_compare_items));
         m_tab8_montar_sinais_compare_combo[i].CheckBoxMode(false);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().XGap(1);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().XSize(montar_sinais_compare_w-2);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().YSize(montar_sinais_combo_h);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().BackColor(clrWhite);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().BackColorHover(clrWhite);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().BorderColor(tab2_border);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().IconXGap((montar_sinais_compare_w-2)-18);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().LabelXGap(10);
         m_tab8_montar_sinais_compare_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
         for(int p=0;p<ArraySize(montar_sinais_compare_items);p++) m_tab8_montar_sinais_compare_combo[i].SetValue(p,montar_sinais_compare_items[p]);
         m_tab8_montar_sinais_compare_combo[i].GetListViewPointer().YSize(160);
         m_tab8_montar_sinais_compare_combo[i].GetListViewPointer().LightsHover(true);
         m_tab8_montar_sinais_compare_combo[i].GetListViewPointer().BackColor(clrWhite);
         if(!m_tab8_montar_sinais_compare_combo[i].CreateComboBox("",montar_sinais_compare_x,montar_sinais_row_y))
            return(false);
         ...
         m_tab8_montar_sinais_compare_value_combo[i].XSize(montar_sinais_value_w);
         ...
         m_tab8_montar_sinais_compare_value_combo[i].GetButtonPointer().XSize(montar_sinais_value_w-2);
         ...
         m_tab8_montar_sinais_compare_value_combo[i].GetButtonPointer().IconXGap((montar_sinais_value_w-2)-18);
         ...
         m_tab8_montar_sinais_compare_value_combo[i].SelectItem(0);

         m_tab8_montar_sinais_compare_candle_combo[i].MainPointer(m_tab8_montar_sinais_card);
         m_tab8_montar_tabs.AddToElementsArray(1,m_tab8_montar_sinais_compare_candle_combo[i]);
         m_tab8_montar_sinais_compare_candle_combo[i].XSize(montar_sinais_candle_w);
         m_tab8_montar_sinais_compare_candle_combo[i].YSize(montar_sinais_combo_h);
         m_tab8_montar_sinais_compare_candle_combo[i].BackColor(clrWhite);
         m_tab8_montar_sinais_compare_candle_combo[i].BackColorHover(clrWhite);
         m_tab8_montar_sinais_compare_candle_combo[i].BackColorPressed(clrWhite);
         m_tab8_montar_sinais_compare_candle_combo[i].BorderColor(tab2_border);
         m_tab8_montar_sinais_compare_candle_combo[i].BorderColorHover(tab2_border);
         m_tab8_montar_sinais_compare_candle_combo[i].BorderColorPressed(tab2_border);
         m_tab8_montar_sinais_compare_candle_combo[i].FontSize(10);
         m_tab8_montar_sinais_compare_candle_combo[i].ItemsTotal(ArraySize(montar_sinais_candle_items));
         m_tab8_montar_sinais_compare_candle_combo[i].CheckBoxMode(false);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().XGap(1);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().XSize(montar_sinais_candle_w-2);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().YSize(montar_sinais_combo_h);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().AnchorRightWindowSide(false);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().BackColor(clrWhite);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().BackColorHover(clrWhite);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().BackColorPressed(clrWhite);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().BorderColor(tab2_border);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().BorderColorHover(tab2_border);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().BorderColorPressed(tab2_border);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().IconXGap((montar_sinais_candle_w-2)-18);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().LabelXGap(10);
         m_tab8_montar_sinais_compare_candle_combo[i].GetButtonPointer().LabelColor(C'43,43,43');
         for(int p=0;p<ArraySize(montar_sinais_candle_items);p++) m_tab8_montar_sinais_compare_candle_combo[i].SetValue(p,montar_sinais_candle_items[p]);
         m_tab8_montar_sinais_compare_candle_combo[i].GetListViewPointer().YSize(120);
         m_tab8_montar_sinais_compare_candle_combo[i].GetListViewPointer().LightsHover(true);
         m_tab8_montar_sinais_compare_candle_combo[i].GetListViewPointer().BackColor(clrWhite);
         if(!m_tab8_montar_sinais_compare_candle_combo[i].CreateComboBox("",montar_sinais_compare_candle_x,montar_sinais_row_y))
            return(false);
         AddToElementsArray(m_window_index,m_tab8_montar_sinais_compare_candle_combo[i]);
         m_tab8_montar_sinais_compare_candle_combo[i].SelectItem(0);
