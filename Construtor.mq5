...
input double InpStopMovelCandlesDisparoDistancia = 1.0;
...
input ENUM_CONSTRUTOR_POSICAO_REFERENCIA InpStopMovelCandlesCandlePosicao = CONSTRUTOR_POSICAO_ATUAL;
...
void LoadInputsToSettings(void)
  {
   ...
   g_settings.stop_movel_candles_disparo_distancia=InpStopMovelCandlesDisparoDistancia;
   ...
   g_settings.stop_movel_candles_candle_posicao=InpStopMovelCandlesCandlePosicao;
