...
PARAMETERS: tuple[ParameterDefinition, ...] = (
    ...
    ParameterDefinition(
        "signals.channels.enabled",
        "Ativar canais de bandas",
        "bool",
        False,
        "signals.channels",
    ),
    ParameterDefinition(
        "signals.channels.indicator",
        "Indicador dos canais",
        "string",
        "Bandas de Bollinger",
        "signals.channels",
    ...
    ParameterDefinition(
        "signals.channels.price",
        "Modo de preco dos canais",
        "string",
        "Fechamento",
        "signals.channels",
    ...
    ParameterDefinition(
        ...
        "none",
        "take_profit",
        ("none", "fixed", "calc", "mult", "indicador"),
    ),
    ParameterDefinition(
        "take_profit.measure",
        "Tipo de take profit",
    ...
    ParameterDefinition(
        "take_profit.fixed.method",
        "Metodo fixo do take profit",
        "string",
        "distance",
        "take_profit.fixed",
        ("distance", "stop_mult"),
    ...
    ParameterDefinition(
        "take_profit.fixed.distance",
        "Distancia do take profit fixo",
        "string",
        "100.0",
        "take_profit.fixed",
    ),
    ParameterDefinition(
        "take_profit.fixed.stop_multiple",
        "Multiplicador do stop no take profit fixo",
        "string",
        "1.0",
        "take_profit.fixed",
    ),
    ParameterDefinition(
        "take_profit.mult.base",
        "Base do multiplicador do take profit",
        "string",
        "Corpo do candle",
        "take_profit.mult",
        ("Corpo do candle", "Range (pavio a pavio)"),
    ...
    ParameterDefinition(
        "take_profit.mult.candle",
        "Candle do multiplicador do take profit",
        "string",
        "Penultimo",
        "take_profit.mult",
        ("Atual", "Ultimo", "Penultimo", "Antepenultimo"),
    ...
    ParameterDefinition(
        "take_profit.mult.value",
        "Valor do multiplicador do take profit",
        "string",
        "1.0",
        "take_profit.mult",
    ),
