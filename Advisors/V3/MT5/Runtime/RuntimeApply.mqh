...
void SyncRuntimeConfigFromInputs()
  {
   ...
   g_config.stop_loss.maxmin.enabled=InpUsarStopLossPorMaxMin;
   ...
   g_config.take_profit.mode=InpUsarTakeProfitFixo ? "fixed" : (InpUsarTakeProfitMultiplicador ? "mult" : "none");
   ...
   g_config.take_profit.mult.enabled=InpUsarTakeProfitMultiplicador;
   g_config.take_profit.mult.base=InpBaseDoTakeProfitMultiplicador;
   g_config.take_profit.mult.candle=InpCandleDoTakeProfitMultiplicador;
   g_config.take_profit.mult.value=InpValorDoTakeProfitMultiplicador;
